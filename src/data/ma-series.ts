...
export const MA_CHAPTERS: MaChapter[] = [
  ...
  },
  {
    ...
    taglineKo: "EBITDA add-back 협상이 가격을 흔드는 진짜 무대",
    taglineEn: "The EBITDA add-back battle that actually moves price",
    readingMinutes: 12,
    status: "draft",
    caseKo: "글로벌 케이스 (뱅커 + 딜 결정 예정)",
    caseEn: "Global case (banker + deal TBD)",
  },
  {
