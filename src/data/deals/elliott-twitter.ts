...
const deal: DealData = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "2021년 11월 29일 자진 사임했습니다. 공식 이유는 '트위터가 창업자에게 의존하는 것은 회사에 도움이 되지 않는다'는 것이었습니다. CTO였던 Parag Agrawal이 즉시 후임 CEO로 선임됐습니다. Elliott가 2020년 캠페인에서 주장한 '전업 CEO 필요성'이 18개월 만에 자진 사임 형태로 현실화된 것으로 많은 애널리스트들이 해석했습니다.",
    },
    {
