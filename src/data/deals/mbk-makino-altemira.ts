...
const deal: DealData = {
  ...
  // ── Control Battle Overview: 13개월 5중 구조 타임라인 ────────
  controlBattleOverview: {
    body: "Nidec의 적대적 TOB로 시작된 이 13개월짜리 사건은 [공격, 방어, 백기사, 정부 개입, 우회] 다섯 무대에서 동시 진행됐다. 같은 일본 정부가 같은 MBK에 19일 간격으로 정반대 판정을 내린 점이 이 케이스를 한국·글로벌 PE 시장의 분기점으로 만들었다.",
    catalyst: "2025년 4월 4일, 일본 상장 모터 대기업 Nidec이 도쿄증시 1부 상장 공작기계 제조사 Makino에 주당 11,000엔·총 2,570억엔(약 USD 1.78B) 규모의 적대적 TOB를 개시. 일본에서 보기 드문 상장사의 상장사 적대적 인수 시도가 사건의 출발점.",
    attackerLabel: "Nidec (적대적 TOB) → 이후 MBK (백기사 TOB)",
    defenderLabel: "Makino 이사회 → 일본 정부 FEFTA",
    battleMoves: [
      {
        date: "2025-04-04",
        actor: "Nidec",
        side: "attack",
        move: "Nidec 적대적 TOB 개시 — ¥11,000/주, ¥257B",
        detail: "도쿄증시 1부 상장 모터 대기업 Nidec이 Makino에 적대적 TOB 개시. 주당 11,000엔(직전 종가 대비 +42% 프리미엄), 총 2,570억엔 규모. 일본에서 상장사가 상장사를 적대적으로 노리는 드문 사례.",
        weapon: "적대적 TOB",
        financialImpact: "Makino 주가 +30%대 급등",
      },
      {
        date: "2025-04-21",
        actor: "Makino 이사회",
        side: "defense",
        move: "포이즌필 도입 의결 — 신주예약권 무상할당",
        detail: "Makino 이사회가 [신주예약권 무상할당(포이즌필)] 도입을 의결하고 6월 정기주총 승인 추진. Nidec이 일정 지분 이상 취득 시 기존 주주에게 신주를 저가로 발행해 Nidec 지분을 희석시키는 방어 장치.",
        weapon: "포이즌필 (Poison Pill)",
      },
      {
        date: "2025-04-25",
        actor: "도쿄지방재판소",
        side: "neutral",
        move: "Nidec 가처분 신청 기각 — TOB 경로 봉쇄",
        detail: "Nidec이 포이즌필을 막기 위해 도쿄지법에 가처분을 신청했으나 기각. 가처분 기각으로 Nidec의 TOB가 사실상 봉쇄됐고, 한 달 만에 Nidec은 TOB 철회.",
        weapon: "법원 가처분 기각",
      },
      {
        date: "2025-05-31",
        ...
        side: "attack",
        move: "Nidec TOB 철회",
        detail: "포이즌필과 가처분 기각으로 TOB 진행 동력을 잃은 Nidec이 공식적으로 TOB를 철회. 1라운드 종결.",
      },
      {
        date: "2025-06-15",
        actor: "Makino 이사회 → MBK파트너스",
        side: "defense",
        move: "백기사 선정 — Carlyle 따돌리고 MBK 우협 확보",
        detail: "Makino 이사회는 백기사 후보로 [Carlyle(미국 PE)과 MBK파트너스]를 동시 협상. 2025년 6월 MBK가 우협 지위 획득. MBK는 신설 SPV [MM Holdings]를 통해 주당 [11,751엔(Nidec 가격보다 +6.8% 추가)], 총 약 [2,748억엔(약 2조 원)] 완전 자회사화 TOB 계획.",
        weapon: "백기사 (White Knight) + +6.8% 프리미엄",
        financialImpact: "Makino 주가 ¥11,800대 안착",
      },
      {
        date: "2026-04-22",
        actor: "일본 재무성 · 경제산업성 (METI)",
        side: "neutral",
        move: "FEFTA 27조 5항 중지권고 발령 — 18년 만의 첫 사례",
        detail: "MBK TOB 클로징을 한 달 앞두고 일본 정부가 외환법(FEFTA) 제27조 5항에 근거 [중지권고(中止勧告)] 발령. [2017년 외환법 개정 이후 첫 사례, 2008년 TCI–J-Power 분쟁 이후 18년 만의 중지권고.] 명분: 마키노 머시닝센터의 dual-use 기술(방위·항공·반도체·의료기기). 미·중·유럽은 이미 모두 승인했지만 일본만 차단.",
        weapon: "외환법 중지권고 (FEFTA Article 27.5)",
        financialImpact: "Makino 주가 ¥11,000대로 회귀",
      },
      {
        date: "2026-05-02",
        actor: "MBK파트너스",
        side: "attack",
        move: "MBK 마키노 TOB 철회 (권고 수용)",
        detail: "MBK는 10일 시한 내 중지권고를 수용하고 마키노 TOB 제안을 철회. 거부 시 법적 구속력 있는 변경·중지 명령으로 격상 가능했고, 일본 시장 장기 신뢰 손상 위험이 컸기 때문. 2라운드 종결.",
      },
      {
        date: "2026-05-11",
        actor: "MBK파트너스",
        side: "defense",
        move: "[19일 피벗] Apollo로부터 Altemira 우회 인수 발표",
        detail: "마키노 철회 19일 만에 MBK가 Apollo Global Management로부터 [Altemira Holdings(일본 알루미늄 캔 3위)] 지분 100%를 [1,175억엔(부채 포함 1,300억엔, 약 1.1~1.2조 원)]에 인수한다고 발표. Altemira는 리튬이온 배터리 부품 생산으로 핵심업종 FEFTA 사전심사 대상이었음에도 약 2개월 만에 승인. [같은 정부·같은 운용사·정반대 판정]. MBK 자체 AI 에이전트(통칭 Project Athena)의 병렬 타깃 트래킹이 19일 피벗의 배경으로 거론.",
        weapon: "우회 인수 + 전사 AI 의사결정",
      },
    ],
    financialWeapons: [
      {
        name: "적대적 TOB (Hostile Tender Offer)",
        side: "attack",
        usedBy: "Nidec",
        description: "이사회 동의 없이 주주에게 직접 제안. +42% 프리미엄(¥11,000)으로 주주 응모 유도. 포이즌필 + 법원 가처분 기각으로 무산.",
        effectiveness: "blocked",
      },
      {
        name: "포이즌필 (신주예약권 무상할당)",
        side: "defense",
        usedBy: "Makino 이사회",
        description: "적대적 인수자가 일정 지분 이상 취득 시 신주를 기존 주주에게 저가로 발행해 인수자 지분을 희석. 일본형 포이즌필. Nidec 격퇴의 핵심.",
        effectiveness: "decisive",
      },
      {
        name: "백기사 영입 (White Knight)",
        side: "defense",
        usedBy: "Makino 이사회",
        description: "Carlyle과 MBK 동시 협상으로 가격 경쟁 유도. MBK가 Nidec +6.8%인 ¥11,751로 우협 확보. 그러나 FEFTA에 막힘.",
        effectiveness: "blocked",
      },
      {
        name: "외환법 중지권고 (FEFTA Article 27.5)",
        side: "neutral",
        usedBy: "일본 재무성 · METI",
        description: "2017년 개정 외환법의 사후 개입 권한 9년 만의 첫 발동. 2008년 TCI–J-Power 이후 18년 만의 중지권고. 명분은 dual-use 기술 보호. 한국·글로벌 PE의 일본 진출 시 사전 분류 매트릭스가 필수가 됨.",
        effectiveness: "decisive",
      },
      {
        name: "전사 AI 에이전트 (Project Athena)",
        side: "attack",
        usedBy: "MBK파트너스",
        description: "거래 소싱·밸류에이션·포트폴리오 관리에 자체 AI 의사결정 시스템 운영. 월 2만 건+ 분석. 마키노 협상 중에도 일본 내 대체 타깃을 병렬 트래킹해 19일 피벗 가능케 함. 글로벌 메가 PE의 외부 AI 라이선싱 모델과 다른 자체 운영 노선.",
        effectiveness: "decisive",
      },
    ],
    turningPoint: {
      date: "2026-04-22",
      event: "일본 정부 FEFTA 중지권고 — 18년 만의 첫 사례",
      detail: "13개월짜리 사건의 결정적 변곡점. 일본 재무성·METI가 외환법 제27조 5항에 근거 MBK에 중지권고를 발령하면서 마키노 인수가 사실상 차단됐다. 미국·중국·유럽이 모두 승인한 거래를 일본만 단독 차단한 이 결정이 한국·글로벌 PE의 일본 진출 전략을 재정의했다. 같은 정부가 19일 뒤 Altemira(알루미늄 캔)는 약 2개월 만에 승인한 점이 [FEFTA가 무차별 차단이 아닌 dual-use risk 매트릭스 운용]임을 명확히 함.",
    },
    verdict: {
      winner: "draw",
      winnerLabel: "Makino 독립 유지 + MBK는 Altemira로 우회 인수 — 다층적 결말",
      margin: "Makino: Nidec과 MBK 둘 다 막아냄 / MBK: 일본 시장 노출 절반(¥274.8B → ¥117.5B)으로 조정 / 일본 정부: FEFTA 운용 의지 시그널링",
      note: "단일 승자를 가리기 어려운 다층적 결말. Makino는 독립을 지켰고, MBK는 일본 시장 진출 자체는 유지했으며, 일본 정부는 dual-use 자산 보호 의지를 명확히 했다. 한국·글로벌 PE에는 [일본 진출 시 자산별 dual-use 분류가 거래 가능성을 결정한다]는 새 표준이 남았다.",
    },
    priceImpact: {
      preContest: "¥10,290 (Nidec TOB 직전, 2025.04.03)",
      peak: "¥11,800대 (MBK TOB 가격 ¥11,751, 2025.06~2026.03)",
      postContest: "¥11,000대 (FEFTA 중지권고 후, 2026.05)",
      note: "Makino 주가는 Nidec TOB 발표(+30%대 급등) → MBK 백기사 ¥11,751 안착 → FEFTA 중지권고 후 ¥11,000대 회귀의 궤적. Altemira는 비상장(Apollo→MBK 직거래)이라 시장 가격 형성 없음. 인수가 ¥117.5B / 부채 포함 ¥130B 기준 EV/EBITDA 약 8.1x.",
    },
  },
