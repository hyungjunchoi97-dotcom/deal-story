/**
 * Emart x Starbucks Korea (Coffee Korea Company) — ₩4.7T acquisition, July 2021
 * Shinsegae Group's full takeover of 24-year JV partner's stake; brand subsidiary repatriation.
 */
import type { DealData } from "@/lib/deal-data";

const deal: DealData = {
  slug: "emart-starbucks-korea",
  title: "How Emart Brought Starbucks Korea Home for ₩4.7T — A 24-Year JV Becomes a Subsidiary",
  subtitle:
    "Shinsegae's Full Control of Korea's #1 Cafe Chain · Two-Step Structure · Emart 67.5% + GIC 32.5% · US Parent at 0%",
  category: "ma",
  industry: "Retail / F&B / Cafe Chain",
  country: "South Korea / USA / Singapore",
  announcedAt: "2021-07-27",
  closedAt: "2021-10-29",
  announcedDisplay: "July 27, 2021",
  closedDisplay: "October 29, 2021",
  readingMinutes: 13,
  tags: [
    "Emart",
    "Starbucks Korea",
  ...
  excerpt:
    "On July 27, 2021, Shinsegae Group's Emart announced the acquisition of the remaining 50% stake in Starbucks Korea from US-based Starbucks Corporation for approximately ₩4.7 trillion (about USD 3.7B). Not a routine equity transaction but the largest [brand subsidiary repatriation] in Korean retail history, ending a 24-year 50/50 joint venture. The deal was structured in two steps [Emart buying 17.5% directly for ₩1.65T] and [Singapore sovereign wealth fund GIC buying 32.5% for ₩2.9T as long-term strategic partner], leaving Emart with 67.5%, GIC with 32.5%, and Starbucks Corp with 0% equity (retaining only a brand licensing relationship).",

  acquirer: { initials: "EM", bg: "bg-yellow-500", label: "Emart (Shinsegae Group)" },
  target: { initials: "SBK", bg: "bg-green-700", label: "Starbucks Coffee Korea" },
  ...
  industryOverview: {
    body: "Korea's coffee market in the late 2010s and early 2020s bifurcated into [premium franchise chains versus value chains]. At the time of the 2021 announcement, the Korean coffee market was estimated at roughly ₩6.8T with approximately 83,000 cafes operating nationwide — among the highest cafe densities per capita globally. Starbucks Korea was no longer the leader by raw store count (Mega Coffee was approaching 3,000 stores by 2024) but remained the dominant #1 by revenue, average ticket, brand strength, and digital infrastructure. Korea was also one of Starbucks Corp's top three markets worldwide by revenue, behind only the US and China.",
    metrics: [
      { label: "Korea coffee market (2021)", value: "approx. ₩6.8T", sub: "Euromonitor estimate" },
      { label: "Starbucks Korea revenue (2021)", value: "approx. ₩1.9T", sub: "at announcement" },
      { label: "Starbucks Korea stores (2021)", value: "approx. 1,500", sub: "all directly operated" },
      { label: "Starbucks Korea stores (2024)", value: "approx. 1,900", sub: "+400 since deal close" },
    ],
    subBody:
    ...
    players: [
      { name: "Starbucks Korea (SCK Company)", role: "Korea's #1 cafe chain by revenue, ticket, and brand power" },
      { name: "Mega Coffee", role: "#1 by store count in value segment, approximately 3,000 stores in 2024" },
      { name: "A Twosome Place (Carlyle)", role: "Premium dessert cafe under PE ownership" },
      { name: "Ediya Coffee", role: "Long-standing value chain, also at the ~3,000-store scale" },
      { name: "Starbucks Corporation (US parent)", role: "Post-deal 0% equity; brand licensor only" },
    ],
  },

  companyOverview: {
    targetName: "Starbucks Coffee Korea (renamed SCK Company)",
    body: "Starbucks Korea was incorporated in September 1997 as a 50/50 joint venture between Emart (Shinsegae Group) and Starbucks Corporation. After opening the first store at Ewha Womans University on July 27, 1999, the company became the de facto standard-setter for Korean cafe culture, leading the local market in mobile ordering (Siren Order, launched in 2014), mobile payments, and rewards. In the fiscal year immediately preceding the deal (FY2020), the company reported revenue of approximately ₩1.93T and operating income of approximately ₩164B, retaining the #1 position in Korea's cafe industry. All stores are directly operated (no franchising), and Korea is one of the fastest-growing markets globally for Starbucks-branded digital commerce and store productivity.",
    metrics: [
      { label: "Founded", value: "September 1997", sub: "50/50 JV: Emart and Starbucks Corp" },
      { label: "First store", value: "July 1999 (Ewha)", sub: "origin point of modern Korean cafe culture" },
      { label: "FY2020 revenue", value: "approx. ₩1.93T", sub: "fiscal year before the deal" },
      { label: "FY2020 operating income", value: "approx. ₩164B", sub: "OPM 8.5%" },
      { label: "Stores (2021)", value: "approx. 1,500", sub: "100% directly operated" },
    ],
    financials: [
  ...
  dealStructure: {
    ...
    preOwnership: {
      nodes: [
        { id: "sbux_pre", label: "Starbucks Corp (US parent)", sub: "50%", type: "acquirer" },
        { id: "emart_pre", label: "Emart (Shinsegae Group)", sub: "50%", type: "entity" },
        { id: "sbk_pre", label: "Starbucks Korea", sub: "50/50 JV (1997 to 2021)", type: "target" },
      ],
      edges: [
    ...
    postOwnership: {
      nodes: [
        { id: "emart_post", label: "Emart", sub: "67.5% (50% + new 17.5%)", type: "acquirer" },
        { id: "gic_post", label: "GIC (Singapore SWF)", sub: "32.5% strategic partner", type: "fund" },
        { id: "sbux_post", label: "Starbucks Corp", sub: "0% (brand licensor only)", type: "entity" },
        { id: "sbk_post", label: "SCK Company (formerly Starbucks Korea)", sub: "Shinsegae subsidiary", type: "target" },
      ],
      edges: [
        { from: "emart_post", to: "sbk_post", label: "67.5% (controlling shareholder)" },
        { from: "gic_post", to: "sbk_post", label: "32.5% (strategic partner)" },
        { from: "sbux_post", to: "sbk_post", label: "brand licensing agreement" },
      ],
    },
    keyTerms: [
      { label: "Total transaction value", value: "approx. ₩4.7T (USD ~3.7B)", accent: true },
      { label: "Step 1 — Emart purchase", value: "17.5% stake for approx. ₩1.65T" },
      { label: "Step 2 — GIC purchase", value: "32.5% stake for approx. ₩2.9T", accent: true },
      { label: "Post-deal Emart stake", value: "67.5% (existing 50% + new 17.5%)" },
      { label: "Post-deal GIC stake", value: "32.5% (long-term strategic partner)" },
      { label: "Post-deal Starbucks Corp stake", value: "0% (continues as brand licensor)", accent: true },
      { label: "Super-majority threshold", value: "cleared (Korean Commercial Act 2/3 line)" },
      { label: "Deal form", value: "Two SPAs closed simultaneously" },
      { label: "Licensing arrangement", value: "Starbucks Corp retains brand, menu standards, bean supply" },
      { label: "Announcement / closing", value: "2021-07-27 / 2021-10-29" },
    ],
  },

  advisors: {
    body: "Given the three-country cross-border structure (Korean buyer, US seller, Singapore co-buyer), both sides assembled full lineups of global investment banks and top Korean law firms. Emart used Samsung Securities and Mirae Asset Securities as joint financial advisors with Kim and Chang as legal counsel. Starbucks Corp was advised by Bank of America with Skadden, Arps as US counsel. GIC ran the transaction primarily through its in-house M&A team with Citi providing supporting financial advice.",
    sides: [
      {
        side: "acquirer",
        sideLabel: "Emart (Acquirer) and GIC (Co-acquirer)",
        initials: "EM",
        bg: "bg-yellow-500",
        advisors: [
          {
            firm: "Samsung Securities",
            role: "Financial advisor (FA, Emart, joint)",
            roleType: "financial",
            note: "Joint lead on deal structure design and price negotiation for Emart",
          },
          {
            firm: "Mirae Asset Securities",
            role: "Financial advisor (FA, Emart, joint)",
            roleType: "financial",
            note: "Supporting role on consortium structuring with GIC",
          },
          {
            firm: "Kim and Chang",
            role: "Legal advisor (Emart)",
            roleType: "legal",
            note: "M&A agreements, antitrust, FX regulation, and brand licensing review",
          },
          {
            firm: "Citi (for GIC)",
            role: "Financial advisor (FA, GIC)",
            roleType: "financial",
            note: "GIC in-house M&A team led; Citi provided market analysis and valuation support",
          },
        ],
      },
      {
        side: "target",
        sideLabel: "Starbucks Corporation (Seller)",
        initials: "SBX",
        bg: "bg-green-700",
        advisors: [
          {
            firm: "Bank of America (BofA)",
            role: "Financial advisor (FA)",
            roleType: "financial",
            note: "Lead FA for Starbucks Corp's global capital reallocation and price negotiation",
          },
          {
            firm: "Skadden, Arps, Slate, Meagher and Flom",
            role: "Legal advisor (US side)",
            roleType: "legal",
            note: "Cross-border SPA, brand licensing agreement, and tax structuring",
          },
        ],
      },
    ],
    disclaimer: "Note: Advisor information is based on public reporting and industry sources. Some appointments may not be officially confirmed and could differ from final engagement letters.",
  },

  valuation: {
    body: "Starbucks Corp's 50% sale proceeds of approximately ₩4.55T imply a [100% enterprise value] of approximately ₩9.1 to ₩9.4T for Starbucks Korea. Against FY2020 revenue of approximately ₩1.93T that is roughly [4.7 to 4.9x EV/Revenue] and against FY2020 EBITDA of approximately ₩245B it implies [approximately 37 to 38x EV/EBITDA]. The premium is supported by Starbucks Korea's #1 share of Korea's cafe market, top-tier per-store revenue, leading digital infrastructure, group synergies with Shinsegae, and the opportunity cost to Starbucks Corp of giving up direct equity in a market it will continue to monetize via royalties.",
    rows: [
      { item: "Total transaction proceeds to Starbucks Corp (50%)", val: "approx. ₩4.55T", note: "Step 1 ₩1.65T + Step 2 ₩2.9T", accent: true },
      { item: "Implied 100% enterprise value (EV)", val: "approx. ₩9.1 to 9.4T", note: "50% price grossed up", accent: true },
      { item: "FY2020 revenue", val: "approx. ₩1.93T", note: "audit report basis" },
      { item: "FY2020 operating income", val: "approx. ₩164B", note: "OPM 8.5%" },
      { item: "FY2020 EBITDA (estimate)", val: "approx. ₩245B", note: "operating income plus D&A" },
      { item: "EV / Revenue", val: "approx. 4.7 to 4.9x", note: "premium vs Korean retail averages (1 to 2x)" },
      { item: "EV / EBITDA", val: "approx. 37 to 38x", note: "premium vs global cafe peers (15 to 20x)", accent: true },
      { item: "Step 1 price (Emart, 17.5%)", val: "approx. ₩1.65T", note: "implied per-share unit price" },
      { item: "Step 2 price (GIC, 32.5%)", val: "approx. ₩2.9T", note: "slightly higher per-unit price than Emart's tranche" },
    ],
    disclaimer: "Note: financials reflect FSS DART filings and contemporaneous reporting. EV/EBITDA multiples depend on EBITDA estimation and have been reported in a 30 to 40x range across sources.",
  },

  rationale: {
    buyer: {
      title: "Why Emart and GIC Paid ₩4.7T",
      initials: "EM",
      bg: "bg-yellow-500",
      points: [
    ...
    seller: {
      title: "Why Starbucks Corp Sold a 24-Year Success for ₩4.55T",
      initials: "SBX",
      bg: "bg-green-700",
      points: [
  ...
  tombstone: {
    ...
    acquirerName: "Emart (Shinsegae Group) and GIC Consortium",
    targetName: "Starbucks Korea (renamed SCK Company)",
    dealTitle: "Acquisition of US Parent's Remaining 50% in 24-Year JV via Two-Step Structure",
    dealSize: "approx. ₩4.7T",
    dealSizeUSD: "USD ~3.7B",
    evEbitda: "approx. 37 to 38x",
    closeDate: "October 29, 2021",
  },

  sources: [
    { id: 1, text: "Emart press release — Acquisition of additional stake in Starbucks Coffee Korea (2021-07-27)", url: "https://www.emart.com" },
    ...
    { id: 3, text: "FSS DART (Korea Financial Supervisory Service) — Starbucks Coffee Korea audit reports across multiple years", url: "https://dart.fss.or.kr" },
    { id: 4, text: "Korea Herald — Emart to buy additional 17.5% of Starbucks Korea, taking control (2021-07-27)" },
    { id: 5, text: "Pulse / Maeil Business — GIC to acquire 32.5% of Starbucks Korea in partnership with Emart (2021-07-27)" },
    { id: 6, text: "Bloomberg — Starbucks to sell Korea stake to Emart, GIC (2021-07-27)" },
    { id: 7, text: "Reuters — Emart, GIC to buy Starbucks Korea stake from US parent (2021-07-27)" },
    { id: 8, text: "InvestChosun / TheBell — Starbucks Korea deal structure analysis and advisor lineup (August 2021)" },
    { id: 9, text: "ChosunBiz — Starbucks Korea renamed SCK Company, CEO Song Ho-seop retained (November 2021)" },
    { id: 10, text: "Korea Herald — Starbucks Korea posts record sales under Shinsegae ownership (2024)" },
  ],

  seo: {
    title: "Emart × Starbucks Korea ₩4.7T Deal — How a 24-Year JV Became a Subsidiary",
    description:
      "In July 2021, Emart acquired the remaining 50% of Starbucks Korea from US-based Starbucks Corp for approximately ₩4.7T in a two-step structure (Emart 17.5% + GIC 32.5%), leaving Emart with 67.5% and Starbucks Corp with 0% equity (licensor only). A deep dive into the global template for JV-to-subsidiary repatriations.",
    keywords: [
      "Emart Starbucks Korea acquisition",
      "Starbucks Korea GIC",
      "Shinsegae Starbucks",
      "Starbucks Korea buyout 4.7 trillion",
      "JV to subsidiary transition",
      "SCK Company",
      "Korean retail M&A",
      "brand licensing transition",
      "Howard Schultz licensing strategy",
      "Emart GIC consortium",
      "Korea cafe market leader",
    ],
  },

  concepts: [
    {
      term: "JV-to-Subsidiary Transition",
      description:
    ...
    {
      term: "Anchor LP / Sovereign Wealth Co-Investor",
      description:
    ...
    {
      term: "Korean Vertical Integration",
      description:
    ...
    {
      term: "Licensing vs Equity Structure",
      description:
    ...
    {
      term: "Strategic Capital Reallocation",
      description:
    ...
    {
      term: "Brand Subsidiary Repatriation",
      description:
    ...
    {
      term: "Sovereign Wealth Strategic Partner",
      description:
