/**
 * Alimentation Couche-Tard × Seven & i Holdings Hostile Bid
 * $47B World's Largest Convenience Store Hostile M&A · Japan Economic Security Law Defense · MBO Review
 */
...
const deal: DealData = {
  ...
  subtitle: "Canada's Circle K vs Japan's 7-Eleven · Economic Security Law Defense · MBO Review · Watershed for Japanese Governance Reform",
  category: "control",
  industry: "Retail & Convenience Stores",
  country: "Canada · Japan",
  announcedAt: "2024-08-19",
  closedAt: "2025-12-31",
  ...
  excerpt:
    "Canadian convenience store giant Alimentation Couche-Tard's $47 billion (¥7.0 trillion) bid for Japan's Seven & i Holdings, operator of 7-Eleven. An analysis of Japan's three-layered defense — the Economic Security Act, management buyout (MBO), and defensive restructuring — against Canadian capital.",

  acquirer: { initials: "ATD", bg: "bg-red-700", label: "Alimentation Couche-Tard Inc." },
  target: { initials: "7&i", bg: "bg-green-700", label: "Seven & i Holdings Co., Ltd." },
  ...
  dealSummary: {
    ...
    acquirerName: "Alimentation Couche-Tard Inc. (TSX: ATD)",
    targetName: "Seven & i Holdings Co., Ltd. (TYO: 3382)",
    announcedDisplay: "August 2024",
    closedDisplay: "Ongoing",
    country: "Canada · Japan",
  },
  ...
  industryOverview: {
    body: "The global convenience store industry is a core retail category with a market size exceeding $600 billion annually. Japan possesses the world's most sophisticated convenience store culture, with the three majors — 7-Eleven, Lawson, and FamilyMart — operating more than 55,000 stores nationwide. Convenience stores function as essential life infrastructure beyond mere retail, encompassing financial services (ATMs, insurance), government services, logistics, and food service. Post-COVID, the roles of delivery, premium food, and digital payments at convenience stores have strengthened, accelerating M&A-driven scale competition among global convenience store operators.",
    metrics: [
      { label: "Global Convenience Store Market Size", value: "$600B+", sub: "2024 estimate" },
      { label: "Seven & i Global Store Count", value: "83,000+", sub: "World's largest convenience store chain" },
      { label: "Couche-Tard Global Store Count", value: "16,700+", sub: "Operating in 29 countries" },
      { label: "Seven & i Annual Revenue", value: "~¥12T (~$80B)", sub: "FY2024 consolidated" },
    ],
    subBody:
    ...
    players: [
      { name: "Alimentation Couche-Tard (ATD)", role: "Canada's Circle K parent, aggressive acquirer" },
      { name: "Seven & i Holdings", role: "Japan's 7-Eleven parent, on defense" },
      { name: "Ito Founding Family", role: "Seven & i founding shareholders, potential MBO principals" },
      { name: "Japanese Government", role: "Operator of Economic Security Act, potential defensive partner" },
      { name: "Institutional Investors & Activists", role: "Casting votes between Seven & i's independence strategy and acquisition premium" },
    ],
  },

  companyOverview: {
    targetName: "Seven & i Holdings Co., Ltd.",
    body: "Seven & i Holdings is Japan's largest retail conglomerate, established in 2005 when the Ito-Yokado Group fully consolidated 7-Eleven Japan. The 7-Eleven brand operates in more than 20 countries including the United States, South Korea, Thailand, Taiwan, and Australia. U.S. 7-Eleven grew dramatically with the 2021 acquisition of Marathon Oil's Speedway stations, becoming the largest U.S. convenience store chain. However, low profitability in non-convenience businesses — Ito-Yokado supermarkets, Sogo & Seibu department stores — has drawn conglomerate discount criticism from investors.",
    metrics: [
      { label: "Established", value: "2005", sub: "Ito-Yokado & 7-Eleven Japan integrated holding company" },
      { label: "Global 7-Eleven Store Count", value: "83,000+", sub: "World's largest convenience chain" },
      { label: "Annual Revenue", value: "~¥12T (~$80B)", sub: "FY2024 consolidated" },
      { label: "Market Cap (pre-proposal)", value: "~¥5.5T (~$38B)", sub: "August 2024" },
    ],
    financials: [
      {
        year: "FY2023",
  ...
  controlBattleOverview: {
    body: "The Canadian Circle K parent's $47 billion bid for the Japanese 7-Eleven parent — the convenience store battle of the century. An analysis of Japan's unique corporate defense mechanisms (Economic Security Act, golden parachutes, cross-shareholding) colliding with Canadian capital.",
    catalyst: "Seven & i's low valuation + excessive non-core asset holdings → ATD identifies acquisition opportunity",
    attackerLabel: "Alimentation Couche-Tard (ATD)",
    defenderLabel: "Seven & i Holdings / Japanese Government",
    battleMoves: [
      {
        date: "2024-08-19",
        actor: "Couche-Tard",
        side: "attack",
        move: "Private Acquisition Proposal — $38B (¥5.6T)",
        detail:
        ...
        financialImpact: "Seven & i shares +20%",
      ...
      },
      {
        ...
        actor: "Seven & i",
        side: "defense",
        move: "Economic Security Act Core-Business Designation Application",
        detail:
        ...
        weapon: "Economic Security Act",
      },
      {
        date: "2024-10-01",
        actor: "Couche-Tard",
        side: "attack",
        move: "Revised Proposal — $47B (¥7.0T)",
        detail:
        ...
        financialImpact: "~24% premium to Seven & i market cap",
        weapon: "Sweetened Offer",
      },
      {
        date: "2024-11-01",
        actor: "Seven & i",
        side: "defense",
        move: "Defensive Restructuring Announced — Divesting Non-Core Businesses",
        detail:
        ...
        weapon: "Defensive Restructuring",
      },
      {
        date: "2025-03-01",
        actor: "Seven & i",
        side: "defense",
        move: "MBO (Management Buyout) Under Review — Going-Private Option",
        detail:
        ...
        weapon: "Management Buyout (MBO)",
      },
    ],
    financialWeapons: [
      {
        name: "Economic Security Promotion Act",
        side: "defense",
        usedBy: "Seven & i / Japanese Government",
        description:
      ...
      },
      {
        ...
        side: "defense",
        usedBy: "Ito Founding Family / Seven & i Management",
        description:
    ...
    turningPoint: {
      date: "2024-09-01",
      event: "Seven & i's Economic Security Act Designation — Deal Elevated to National Issue",
      detail:
    ...
    verdict: {
      winner: "draw",
      winnerLabel: "Unresolved (Ongoing as of 2025)",
      margin: "Revised offer under review; MBO being explored in parallel",
      note: "As of 2025, no resolution. Whether Seven & i's economic security law defense plus MBO option can block ATD is the key question. This deal will be a watershed for Japanese corporate governance reform and foreign capital defense.",
    },
    priceImpact: {
      preContest: "¥1,880 (before ATD proposal, August 2024)",
      peak: "¥2,350 (immediately after proposal made public)",
      postContest: "¥2,100 (early 2025, amid uncertainty)",
      note: "Seven & i shares rose 20%+ on the acquisition proposal. MBO premium expectations sustained.",
    },
  },
  ...
  dealStructure: {
    ...
    preOwnership: {
      nodes: [
        {
          id: "ito_family",
          label: "Ito Founding Family",
          sub: "Seven & i major shareholders",
          type: "entity",
        },
        {
          id: "institutional",
          label: "Institutional Investors",
          sub: "Foreign & domestic institutional shareholders",
          type: "fund",
        },
        {
          id: "seven_i",
          label: "Seven & i Holdings",
          sub: "TYO: 3382 listed company",
          type: "target",
        },
        {
          id: "atd",
          label: "Couche-Tard (ATD)",
          sub: "TSX: ATD, acquisition proposal ongoing",
          type: "acquirer",
        },
      ],
      edges: [
        { from: "ito_family", to: "seven_i", label: "Founding family stake (major shareholder)" },
        { from: "institutional", to: "seven_i", label: "Institutional stake" },
        { from: "atd", to: "seven_i", label: "Acquisition proposal ($47B)" },
      ],
    },
    postOwnership: {
      nodes: [
        {
          id: "atd_post",
          label: "Couche-Tard (ATD)",
          sub: "100% ownership if acquisition closes",
          type: "acquirer",
        },
        {
          id: "seven_i_post",
          label: "Seven & i Holdings",
          sub: "Acquisition unresolved / MBO under review",
          type: "target",
        },
        {
          id: "mbo_entity",
          label: "Ito Family + PE (MBO)",
          sub: "Going-private under review",
          type: "fund",
        },
      ],
      edges: [
        {
          from: "atd_post",
          to: "seven_i_post",
          label: "Acquisition attempt ongoing (unresolved)",
        },
        {
          from: "mbo_entity",
          to: "seven_i_post",
          label: "MBO review (alternative scenario)",
        },
      ],
    },
    keyTerms: [
      { label: "Initial Proposal", value: "$38B (¥5.6T)", accent: false },
      { label: "Revised Proposal", value: "$47B (¥7.0T)", accent: true },
      { label: "Premium (Revised)", value: "~24% to market cap", accent: true },
      { label: "Deal Type", value: "All-Cash Tender Offer" },
      { label: "Seven & i Response", value: "Economic Security Act + Restructuring + MBO Review" },
      { label: "Japanese Government Role", value: "Economic Security Act review authority" },
      { label: "Deal Status", value: "Ongoing / Unresolved" },
    ],
  },

  advisors: {
    body: "This deal has mobilized the world's top investment banks and law firms across Canada, Japan, and the United States. ATD's side focuses on large-scale financing and Japan regulatory navigation; Seven & i's side focuses on defensive strategy structuring, MBO review, and Economic Security Act proceedings.",
    sides: [
      {
        side: "acquirer",
        sideLabel: "Couche-Tard (Acquirer)",
        initials: "ATD",
        bg: "bg-red-700",
        advisors: [
          {
            ...
            roleType: "financial",
            note: "Acquisition structure design, valuation, and financing strategy",
          },
          {
            firm: "Davies Ward Phillips & Vineberg",
            role: "Legal Advisor (Canada)",
            roleType: "legal",
            note: "Canadian M&A legal advisory",
          },
          {
            firm: "Nagashima Ohno & Tsunematsu",
            role: "Legal Advisor (Japan)",
            roleType: "legal",
            note: "Japan Economic Security Act review response and local M&A regulatory advisory",
          },
        ],
      },
      {
        side: "target",
        sideLabel: "Seven & i Holdings (Defense)",
        initials: "7&i",
        bg: "bg-green-700",
        advisors: [
          {
            firm: "Nomura Securities / Mizuho",
            role: "Financial Advisor",
            roleType: "financial",
            note: "Defense strategy structuring, MBO advisory, standalone valuation",
          },
          {
            firm: "Mori Hamada & Matsumoto",
            role: "Legal Advisor (Japan)",
            roleType: "legal",
            note: "Economic Security Act core-business designation, board defense strategy",
          },
          {
            firm: "Sullivan & Cromwell",
            role: "Legal Advisor (International)",
            roleType: "legal",
            note: "U.S. securities law and international M&A regulatory compliance",
          },
        ],
      },
    ],
  ...
  rationale: {
    buyer: {
      title: "Couche-Tard's Acquisition Rationale",
      initials: "ATD",
      bg: "bg-red-700",
      points: [
    ...
    seller: {
      title: "Seven & i's Independence Rationale",
      initials: "7&i",
      bg: "bg-green-700",
      points: [
  ...
  sources: [
    { id: 1, text: "Alimentation Couche-Tard Press Release — Initial Proposal to Seven & i (August 2024)" },
    { id: 2, text: "Seven & i Holdings IR Disclosure — Response to ATD Proposal (September 2024)" },
    { id: 3, text: "Bloomberg — Couche-Tard Raises 7-Eleven Offer to $47 Billion (October 2024)" },
    { id: 4, text: "Nikkei Asia — Seven & i Files for Economic Security Designation (September 2024)" },
    { id: 5, text: "Wall Street Journal — Seven & i Explores Management Buyout as Defense (2025)" },
    { id: 6, text: "Financial Times — Japan's Convenience Store Battle and Governance Reform (2024–2025)" },
  ],

  seo: {
    title: "Couche-Tard vs 7-Eleven Complete Analysis — The $47B Convenience Store Hostile M&A",
    description:
      "Complete analysis of Couche-Tard's hostile bid for Seven & i Holdings. The $47B proposal, Japan's Economic Security Act defense, MBO review, and what this means for Japanese corporate governance reform.",
    keywords: [
      "Couche-Tard Seven & i acquisition",
      "7-Eleven hostile takeover",
      "Japan Economic Security Act M&A",
      "Seven & i MBO",
      "Circle K 7-Eleven merger",
      "Japanese corporate governance",
      "convenience store hostile bid",
      "ATD Seven i bid",
    ],
  },
  ...
  concepts: [
    {
      term: "Economic Security Promotion Act (Japan)",
      description:
