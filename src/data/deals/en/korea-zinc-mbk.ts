...
const koreaZincMbk: DealData = {
  ...
  closedDisplay: "Apr 2026 (Supreme Court final ruling)",
  readingMinutes: 18,
  tags: [
    "tender-offer",
    "control-contest",
  ...
  excerpt:
    "The hostile tender offer launched by MBK Partners and Young Poong on Sep 13, 2024 opened an 18-month control battle that played out across two distinct rounds. Round 1 (Sep 2024–Mar 2025) ended with Chairman Choi's defense holding via dueling tender offers, EGM proxy fight, and court injunctions — the share price tripled from ₩515,000 to ₩1,630,000 along the way. Round 2 (Apr 2025–Apr 2026) reset the entire game: Korea Zinc issued ₩2.85 trillion in new shares to a U.S. Department of Defense / Department of Commerce joint venture (\"Crucible JV\"), announced an ₩11 trillion smelter in Tennessee, and the Supreme Court (Apr 2, 2026) confirmed the cross-shareholding mechanism that disenfranchised Young Poong. Stock: ₩515K → ₩1.63M (Round 1 peak) → ₩640K → ₩1.91M (Round 2 peak) → ~₩1.53M (May 2026).",
  ...
  // ── Deal Summary ──────────────────────────────────────────────
  dealSummary: {
    dealValueDisplay: "Round 1 ~₩2.4T tender offers + Round 2 ₩2.85T Crucible JV PIPE",
    acquirerName: "MBK Partners + Young Poong → defeated by U.S. DoD/DoC Crucible JV (white knight)",
    targetName: "Korea Zinc Co., Ltd.",
    announcedDisplay: "Sep 13, 2024",
    closedDisplay: "Apr 2, 2026 (Supreme Court final ruling)",
    country: "South Korea",
  },
  ...
  companyOverview: {
    targetName: "Korea Zinc Co., Ltd.",
    body: "Korea Zinc operates the world's largest single-site zinc smelter at Onsan, South Korea. The company refines approximately 1.1 million metric tons of zinc annually — roughly 10% of global production. Beyond zinc and lead, Korea Zinc has long produced silver, gold, indium and germanium as byproducts. In 2025, silver and gold prices surged sharply; precious-metals revenue rose to ~65.7% of mix and underpinned record quarterly results in 1Q 2026. The 'Troika Drive' strategy — EV battery materials, green hydrogen, and solar components — has transitioned from capex burn to revenue generation, and the Dec 2025 Crucible JV repositioned Korea Zinc as a Korea-U.S. critical-minerals supply chain pillar.",
    metrics: [
      { label: "Zinc Smelting Global Share", value: "~10%", sub: "World #1 (Onsan)" },
      { label: "FY2024 Revenue",             value: "~₩12.08T", sub: "+24.5% YoY" },
      { label: "FY2025 Operating Profit",    value: "~₩1.2T", sub: "44 consecutive years / 100 consecutive quarters of profit" },
      { label: "Market Cap (May 2026)",      value: "~₩32T", sub: "3× pre-contest ~₩10.5T" },
    ],
    financials: [
      { year: "2021", revenue: 7820000,  cogs: 6240000,  grossProfit: 1580000, sga: 380000, operatingIncome: 1200000, ebitda: 1680000 },
      { year: "2022", revenue: 9450000,  cogs: 7580000,  grossProfit: 1870000, sga: 410000, operatingIncome: 1460000, ebitda: 1990000 },
      { year: "2023", revenue: 10120000, cogs: 8240000,  grossProfit: 1880000, sga: 380000, operatingIncome: 1500000, ebitda: 2010000 },
      { year: "2024", revenue: 12082800, cogs: 9850000,  grossProfit: 2232800, sga: 430000, operatingIncome:  736100, ebitda: 1290000 },
      { year: "2025", revenue: 13800000, cogs: 11000000, grossProfit: 2800000, sga: 450000, operatingIncome: 1200000, ebitda: 1850000 },
    ],
  ...
  controlBattleOverview: {
    ...
    defenderLabel: "Chairman Choi Yun-bum (Korea Zinc + U.S. Crucible JV)",
    battleMoves: [
      {
        date: "2024-09-13",
      ...
      },
      {
        ...
        actor: "Seoul Court",
        side: "neutral",
        move: "Round 1 Closes — Final Injunction Dismissed",
        detail:
      ...
      },
      {
        ...
        financialImpact: "Stock intraday peak ₩1,910,000 on Dec 15, 2025 (vs. ₩640K Round 1 close — +198%)",
      },
      {
        date: "2025-12-24",
        actor: "Seoul Central District Court",
        side: "neutral",
        move: "Young Poong/MBK Injunction Dismissed — New Share Issuance Approved",
        detail:
        ...
        weapon: "Court Approval",
      },
      {
        date: "2026-03-24",
        actor: "Korea Zinc Annual General Meeting",
        side: "defense",
        move: "AGM — Chairman Choi Re-elected, Crucible JV Director Seated (Board 9:5)",
        detail:
        ...
        weapon: "AGM Proxy Battle",
        financialImpact: "MBK/Young Poong remain on board but board majority firmly secured",
      },
      {
        date: "2026-04-02",
        ...
        financialImpact: "Legal uncertainty cleared; stock stabilized around ₩1,528,000 by May 2026",
      },
      {
        date: "2026-05-01",
        actor: "Market / Press",
        side: "neutral",
        move: "MBK Exit Strategy Surfaces — Drag-Along Right Reported",
        detail:
    ...
    financialWeapons: [
      ...
      {
        name: "Injunction Against New Share Issuance (Round 2)",
        side: "attack",
        usedBy: "MBK Partners + Young Poong",
        description:
      ...
      {
        name: "EGM Proxy Mobilization (NPS)",
        side: "defense",
      ...
      {
        name: "U.S. DoD/DoC White Knight — Crucible JV Private Placement",
        side: "defense",
        usedBy: "Korea Zinc + U.S. Government",
        description:
      ...
      {
        name: "Cross-Shareholding Disenfranchisement",
        side: "defense",
        usedBy: "Korea Zinc + SMC (Australian subsidiary)",
        description:
    ...
    turningPoint: {
      date: "2025-12-15",
      event: "₩2.85 Trillion Crucible JV Private Placement Announced",
      detail:
  ...
  dealStructure: {
    ...
    postOwnership: {
      nodes: [
        { id: "yp_mbk_post", label: "Young Poong + MBK", sub: "~36% (diluted, voting rights restricted)", type: "acquirer" },
        { id: "choi_post",    label: "Chairman Choi + treasury", sub: "~46%", type: "entity" },
        { id: "crucible",    label: "U.S. Crucible JV", sub: "~10.59% (white knight)", type: "fund" },
        { id: "kz_post",     label: "Korea Zinc", sub: "Korea-U.S. strategic asset", type: "target" },
        { id: "nps_post",    label: "NPS", sub: "~7%", type: "fund" },
      ],
      edges: [
        { from: "yp_mbk_post", to: "kz_post", label: "~36% (votes restricted by cross-shareholding)" },
        { from: "choi_post",    to: "kz_post", label: "~46% (in control)" },
        { from: "crucible",    to: "kz_post", label: "10.59% (white knight)" },
        { from: "nps_post",    to: "kz_post", label: "~7%" },
      ],
    },
    keyTerms: [
      { label: "Round 1 Tender Offer Size",      value: "~₩2.4 trillion" },
      { label: "Round 2 Crucible JV PIPE",       value: "~₩2.85 trillion",        accent: true },
      { label: "Tennessee Smelter Investment",    value: "~₩11 trillion ($7.4B)", accent: true },
      { label: "MBK Offer Price",                value: "₩660,000/share" },
      { label: "Korea Zinc Buyback Price",       value: "₩830,000/share" },
      { label: "Crucible JV Subscription Price", value: "₩1,290,000/share",       accent: true },
      { label: "Round 1 Stock Peak",             value: "₩1,630,000 (Oct 2024)" },
      { label: "Round 2 Stock Peak",             value: "₩1,910,000 (Dec 2025)" },
      { label: "Stock (May 2026)",               value: "~₩1,528,000" },
      { label: "Pre-Contest → May 2026",         value: "+197% (₩515K → ₩1.53M)" },
    ],
  },
  ...
  // ── Valuation ─────────────────────────────────────────────────
  valuation: {
    body: "The price trajectory of this 20-month dispute traces \"two surge cycles plus one strategic-asset re-rating.\" Round 1 dueling tender offers pushed the stock ₩515K → ₩1.63M (+217%); Round 2's U.S. white knight pushed ₩640K → ₩1.91M (+198%). The ~₩1.53M level at May 2026 (+197% vs. pre-contest) is the market's pricing of Korea Zinc's new identity as a pillar of the Korea-U.S. critical-minerals supply chain.",
    rows: [
      { item: "Pre-Contest Price (Sep 12, 2024)",         val: "₩515,000",     note: "Day before Round 1 launch" },
      { item: "MBK Tender Offer Price",                    val: "₩660,000",     note: "+28% premium" },
      { item: "Korea Zinc Defensive Buyback Price",        val: "₩830,000",     note: "+61% premium" },
      { item: "Round 1 Peak (Oct 4, 2024)",                val: "₩1,630,000",   note: "+217% in 6 weeks", accent: true },
      { item: "Post-Round 1 Price (Mar 2025)",             val: "₩640,000",     note: "Premium evaporates" },
      { item: "Crucible JV Subscription Price (Dec 2025)", val: "₩1,290,000",   note: "+27% vs prior close ₩1,015,000" },
      { item: "Round 2 Peak (Dec 15, 2025)",               val: "₩1,910,000",   note: "+198% vs Round 1 close", accent: true },
      { item: "Current Price (May 13, 2026)",              val: "~₩1,528,000",  note: "+197% vs pre-contest", accent: true },
      { item: "Round 1 MBK/YP Total Investment",           val: "~₩900B",       note: "14.17% × ₩660K average" },
      { item: "Round 2 Crucible JV Issuance",              val: "~₩2.85T",       note: "2.2M shares × ₩1.29M", accent: true },
      { item: "Tennessee Smelter Investment Plan",         val: "~₩11T ($7.4B)", note: "Groundbreaking 2027, operations 2029" },
    ],
    disclaimer: "Stock prices and investment figures are based on public filings and press reports. Some figures are estimates marked with \"~\" or \"approximately.\"",
  },

  // ── Rationale ─────────────────────────────────────────────────
  rationale: {
    buyer: {
      title: "MBK Partners + Young Poong — Why They Attacked and Why They Lost",
      initials: "MBK",
      bg: "bg-slate-800",
      points: [
    ...
    seller: {
      title: "Chairman Choi — How He Won Both Rounds",
      initials: "KZ",
      bg: "bg-amber-600",
      points: [
  ...
  tombstone: {
    ...
    acquirerName: "MBK Partners + Young Poong (Round 1 attackers)",
    targetName: "Korea Zinc Co., Ltd. — U.S. Crucible JV White Knight",
    dealTitle: "Korea Zinc 18-Month Control Battle — From PE Hostile Bid to U.S. Government White Knight",
    dealSize: "Round 1 ~₩2.4T + Round 2 ~₩2.85T new shares",
  ...
  sources: [
    {
      id: 1,
      text: "MBK Partners + Young Poong joint tender offer announcement, FSS DART (Sep 13, 2024)",
    },
    {
      id: 2,
      text: "Korea Zinc board resolution — defensive treasury buyback at ₩830,000/share, DART (Sep 23, 2024)",
    },
    {
      id: 3,
      text: "Seoul Central District Court injunction blocking Korea Zinc treasury share cancellation (Oct 18, 2024)",
    },
    {
      id: 4,
      text: "Korea Zinc Extraordinary General Meeting results, DART (Jan 23, 2025)",
    },
    {
      id: 5,
      text: "Seoul High Court dismissal of MBK Partners' final injunction bid (Mar 28, 2025)",
    },
    {
      id: 6,
      text: "Korea Zinc IR — U.S. Smelter Investment Announcement (Dec 15, 2025)",
      url: "https://investors.koreazinc.co.kr/media/h5ypccdz/",
    },
    {
      id: 7,
      text: "DART — Crucible JV private placement decision (Dec 15, 2025, 2.2M new shares at ₩1,290,000)",
    },
    {
      id: 8,
      text: "Seoul Central District Court — Young Poong/MBK injunction against new share issuance dismissed (Dec 24, 2025)",
    },
    {
      id: 9,
      text: "Supreme Court of Korea — Final ruling affirming legality of cross-shareholding voting restriction (Apr 2, 2026)",
    },
    {
      id: 10,
      text: "Korea Zinc 2026 Annual General Meeting results, DART (Mar 24, 2026)",
    },
    {
      id: 11,
      text: "Korea Zinc Annual Reports FY2021–FY2024 + FY2025 preliminary results disclosures (DART)",
    },
    {
      id: 12,
      text: "Korea Zinc 1Q 2026 preliminary operating results — revenue ₩6.07T, operating profit ₩746B (May 2026)",
    },
    {
      id: 13,
      text: "Korea Financial Services Commission — Mandatory Tender Offer rule, Capital Markets Act amendment public comment (Jan 30 – Mar 11, 2026 and Mar 18 – Apr 7, 2026)",
    },
    {
      id: 14,
      text: "Investchosun — Crucible JV ₩2.85T private placement (Dec 15, 2025)",
      url: "https://www.investchosun.com/",
    },
    {
      id: 15,
      text: "KED Global — Seoul court rejects MBK bid to block share sale (Dec 24, 2025)",
    },
    {
      id: 16,
      text: "Law Times — Supreme Court affirms Young Poong voting rights restriction (Apr 2026)",
    },
    {
      id: 17,
      text: "Korea Economic Daily, Maeil Business, Chosun Ilbo, Aju Business, Herald Economy, Money Today — coverage (Sep 2024 – May 2026)",
    },
    {
      id: 18,
      text: "Korea Economic Daily (한국경제), Maeil Business News (매일경제) — Korea Zinc battle coverage (September 2024 – May 2026)",
    },
  ],
  ...
  seo: {
    title:
      "Korea Zinc 18-Month Control Battle — Ended by a U.S. DoD White Knight",
    description:
      "The definitive case study of Korea's largest control battle (Sep 2024 – Apr 2026). MBK Partners + Young Poong's ₩2.4T hostile tender offer (Round 1) was defeated by Chairman Choi's defensive treasury buyback. Round 2: Korea Zinc partnered with the U.S. Department of Defense — a ₩2.85T Crucible JV private placement + ₩11T Tennessee smelter — reshaping the dispute into a Korea-U.S. critical-minerals alignment. Supreme Court affirmed cross-shareholding on April 2, 2026.",
    keywords: [
      "Korea Zinc hostile takeover",
      "MBK Partners Korea Zinc",
      "Korea Zinc U.S. Department of Defense",
      "Crucible JV Korea Zinc",
      "Korea Zinc Tennessee smelter",
      "Korean M&A case study",
      "hostile tender offer Korea",
      "control contest Asia",
      "defensive buyback M&A",
      "Korea Zinc share price",
      "critical minerals supply chain",
      "cross-shareholding voting restriction",
      "mandatory tender offer Korea",
      "Trump 2 critical minerals strategy",
      "PE control contest Korea",
      "Sun Metals Corporation Young Poong",
    ],
  },
  ...
  concepts: [
    ...
    {
      term: "Defensive Treasury Buyback",
      description:
    ...
    {
      term: "Third-Party Private Placement (PIPE-like)",
      description:
    ...
    {
      term: "Cross-Shareholding Voting Restriction",
      description:
    ...
    {
      term: "Critical Minerals Security",
      description:
    ...
    {
      term: "Mandatory Tender Offer Rule",
      description:
