/**
 * Hanmi Pharmaceutical Control Dispute — Jong-yoon Lim vs. Young-sook Song & Joo-hyun Lim
 * Post-founder control battle of Korea's leading pharma company
 */
...
const deal: DealData = {
  ...
  subtitle: "Post-Founder Family Control Battle · OCI Merger Controversy · Innovative Drug Pipeline vs. Corporate Uncertainty",
  category: "control",
  ...
  excerpt:
    "A founding-family control battle that erupted following the death of Sung-ki Lim, the legendary founder of Hanmi Pharmaceutical. Eldest son Jong-yoon Lim versus the mother-daughter alliance (Young-sook Song and Joo-hyun Lim) — a 3-year legal battle dissected in terms of its impact on corporate value and Hanmi's global innovative drug pipeline.",

  acquirer: { initials: "JYL", bg: "bg-blue-700", label: "Jong-yoon Lim (Eldest Son Faction)" },
  target: { initials: "HMP", bg: "bg-red-600", label: "Hanmi Pharmaceutical / Hanmi Science" },
  ...
  dealSummary: {
    ...
    acquirerName: "Jong-yoon Lim (Eldest Son, Director of Hanmi Pharmaceutical)",
  ...
  industryOverview: {
    body: "Korea's pharmaceutical and bio industry began receiving global recognition for its R&D capabilities from the late 2010s, as successful technology licensing (license-out) cases accumulated. Hanmi Pharmaceutical led this trend. As of 2024, Korea's domestic pharmaceutical market is approximately KRW 30 trillion with rapidly expanding biopharma share. Korean firms are growing increasingly competitive in obesity drugs (GLP-1), oncology, and rare disease therapeutics. However, given the nature of drug development, leadership stability and long-term R&D investment continuity are core variables in pharmaceutical company valuation.",
    metrics: [
      { label: "Korea Pharma Market Size", value: "~KRW 30 Trillion", sub: "2024, biopharma share expanding" },
      { label: "Hanmi Pharmaceutical R&D Rate", value: "~15–20% of revenue", sub: "Pipeline-focused investment" },
      { label: "Global Tech Licensing Track Record", value: "KRW 8T+", sub: "Hanmi Pharmaceutical 2015–2016" },
      { label: "Hanmi Science Market Cap", value: "~KRW 3 Trillion", sub: "During dispute period" },
    ],
    subBody:
    ...
    players: [
      { name: "Hanmi Pharmaceutical", role: "Korea's leading innovative drug developer, disputed operating company" },
      { name: "Hanmi Science", role: "Hanmi Pharmaceutical holding company, core voting rights battlefield" },
      { name: "OCI Group", role: "Proposed merger partner with Hanmi Science (Joo-hyun Lim's side)" },
      { name: "Institutional & Retail Shareholders", role: "AGM voting casting votes" },
    ],
  },

  companyOverview: {
    targetName: "Hanmi Pharmaceutical Co., Ltd. / Hanmi Science Co., Ltd.",
    body: "Hanmi Pharmaceutical is Korea's leading pharmaceutical company, founded by Sung-ki Lim in 1973. Its core business is the manufacture and sale of finished pharmaceuticals, with in-house drug development (R&D) capabilities rated best-in-class among Korean pharma companies. Key pipelines include Rolontis (efbemalenograstim alfa, sustained-release G-CSF for neutropenia), efpeglenatide (GLP-1 diabetes drug), and HM15211 (obesity drug), all in global clinical trials. Hanmi Science, as the holding company of Hanmi Pharmaceutical, is the actual battlefield of this control dispute — the side controlling the holding company's board exercises management authority over the operating company.",
    metrics: [
      { label: "Founded", value: "1973", sub: "Sung-ki Lim, founder" },
      { label: "Annual Revenue (Hanmi Pharma)", value: "~KRW 1.4 Trillion", sub: "FY2023" },
      { label: "R&D Pipeline", value: "30+ Global Clinical Trials", sub: "Rolontis, efpeglenatide, HM15211, etc." },
      { label: "Hanmi Science Market Cap", value: "~KRW 3 Trillion", sub: "During dispute period" },
    ],
    financials: [
      {
  ...
  controlBattleOverview: {
    ...
    catalyst: "No succession plan established + will authenticity controversy following founder Sung-ki Lim's passing in September 2020",
    attackerLabel: "Jong-yoon Lim Faction (Eldest Son & Some Directors)",
    defenderLabel: "Young-sook Song & Joo-hyun Lim (Mother-Daughter Alliance)",
    battleMoves: [
      {
        date: "2020-09-02",
        actor: "Founder Sung-ki Lim",
        side: "neutral",
        move: "Passing — Management Vacuum Begins",
        detail:
        ...
        weapon: "Estate Inheritance",
      },
      {
        date: "2021-10-01",
        actor: "Jong-yoon Lim",
        side: "attack",
        move: "Independent Management Claim and Board Takeover Attempt",
        detail:
        ...
        weapon: "Board Voting Rights",
      },
      {
        date: "2023-03-28",
        actor: "Both Factions",
        side: "neutral",
        move: "Hanmi Science Extraordinary General Meeting — Proxy Fight",
        detail:
        ...
        financialImpact: "Sharp increase in Hanmi Pharmaceutical share price volatility during dispute",
        weapon: "Shareholder Meeting Proxy Fight",
      },
      {
        date: "2024-03-01",
        actor: "Jong-yoon Lim",
        side: "attack",
        move: "Partial Success in Hanmi Science Director Appointments",
        detail:
      ...
      {
        date: "2024-06-01",
        actor: "Joo-hyun Lim & Young-sook Song faction",
        side: "defense",
        move: "OCI Group Merger Push — New Front in Control Battle",
        detail:
        ...
        weapon: "Strategic M&A Utilization",
      },
    ],
    financialWeapons: [
      {
        name: "Proxy Fight (Shareholder Voting Rights Solicitation)",
        side: "attack",
        usedBy: "Jong-yoon Lim faction",
        description:
      ...
      {
        name: "Board Packing Strategy",
        side: "defense",
        usedBy: "Young-sook Song & Joo-hyun Lim",
        description:
      ...
      {
        name: "Strategic Third-Party Alliance (OCI Merger)",
        side: "defense",
        usedBy: "Joo-hyun Lim & Young-sook Song",
        description:
      ...
      {
        name: "Legal Proceedings (Injunctions & Litigation)",
        side: "attack",
        usedBy: "Jong-yoon Lim faction",
        description:
    ...
    turningPoint: {
      date: "2023-03-28",
      event: "Hanmi Science Extraordinary AGM — Favorable Outcome for Song-Lim Alliance",
      detail:
    ...
    verdict: {
      winner: "draw",
      winnerLabel: "Unresolved (Ongoing)",
      margin: "Partial wins for both sides, no decisive conclusion",
      note: "Dispute continues as of 2025. Management uncertainty is negatively impacting corporate value at a time when Hanmi Pharmaceutical's innovative drug pipeline is attracting global attention.",
    },
    priceImpact: {
      preContest: "₩350,000 (before founder Sung-ki Lim's death, 2020)",
      peak: "₩420,000 (2021 drug pipeline expectations)",
      postContest: "₩300,000 (2023 prolonged dispute)",
      note: "Hanmi Pharmaceutical share price range-bound due to prolonged dispute. Management risk premium emerging against drug pipeline value.",
    },
  },
  ...
  dealStructure: {
    ...
    preOwnership: {
      nodes: [
        {
          id: "founder",
          label: "Founder Sung-ki Lim",
          sub: "Passed away September 2020",
          type: "entity",
        },
        {
          id: "family",
          label: "Heirs (Song, Jong-yoon, Joo-hyun)",
          sub: "Inheritance distribution ongoing",
          type: "entity",
        },
        {
          id: "hmsci",
          label: "Hanmi Science Co., Ltd.",
          sub: "Holding Company — Core Dispute Arena",
          type: "target",
        },
        {
          id: "hanmi",
          label: "Hanmi Pharmaceutical Co., Ltd.",
          sub: "Global Drug Development Operating Company",
          type: "target",
        },
      ],
      edges: [
        { from: "founder", to: "family", label: "Estate inheritance (will disputed)" },
        { from: "family", to: "hmsci", label: "Distributed shareholding" },
        { from: "hmsci", to: "hanmi", label: "Holding → Operating company control" },
      ],
    },
    postOwnership: {
      nodes: [
        {
          id: "jongyoon",
          label: "Jong-yoon Lim (Eldest Son Faction)",
          sub: "Some Hanmi Science directors appointed",
          type: "acquirer",
        },
        {
          id: "mother_daughter",
          label: "Young-sook Song & Joo-hyun Lim",
          sub: "Board majority maintained (2023–)",
          type: "entity",
        },
        {
          id: "hmsci_post",
          label: "Hanmi Science Co., Ltd.",
          sub: "Under dispute — fluid board composition",
          type: "target",
        },
        {
          id: "hanmi_post",
          label: "Hanmi Pharmaceutical Co., Ltd.",
          sub: "Management uncertainty ongoing",
          type: "target",
        },
        {
          id: "oci",
          label: "OCI Group",
          sub: "Merger push ongoing (Joo-hyun Lim faction)",
          type: "fund",
        },
      ],
      edges: [
        { from: "jongyoon", to: "hmsci_post", label: "Some directors secured" },
        { from: "mother_daughter", to: "hmsci_post", label: "Board majority (contested)" },
        { from: "oci", to: "hmsci_post", label: "Merger review ongoing" },
        { from: "hmsci_post", to: "hanmi_post", label: "Holding → Operating" },
      ],
    },
    keyTerms: [
      { label: "Dispute Type", value: "Founding Family Internal Control Battle", accent: true },
      { label: "Hanmi Science Market Cap", value: "~KRW 3 Trillion", accent: true },
      { label: "Core Battlefield", value: "Hanmi Science Board Voting Rights Contest" },
      { label: "Dispute Start", value: "September 2021 (will controversy publicized)" },
      { label: "2023 AGM Result", value: "Song-Lim alliance successfully constitutes favorable board" },
      { label: "2024 AGM Result", value: "Jong-yoon Lim faction partially succeeds in director appointments" },
      { label: "OCI Merger Push", value: "Led by Joo-hyun Lim & Song; opposed by Jong-yoon Lim" },
      { label: "Dispute Status", value: "Ongoing / Unresolved" },
    ],
  },

  advisors: {
    body: "Given this is an intra-family control dispute, publicly available financial advisor information is limited. Both sides have been engaged primarily through legal counsel in proxy fights, director appointment injunctions, and will authenticity litigation. IR communication with institutional investors and proxy solicitation advisory have also played key roles.",
    sides: [
      {
        side: "acquirer",
        sideLabel: "Jong-yoon Lim Faction (Eldest Son)",
        initials: "JYL",
        bg: "bg-blue-700",
        advisors: [
          {
            firm: "Legal Counsel (undisclosed)",
            role: "Legal Advisory",
            roleType: "legal",
            note: "Director appointment injunctions, will authenticity litigation, AGM proxy fight legal response",
          },
          {
            firm: "Shareholder Communication Advisor (undisclosed)",
            role: "IR Advisory",
            roleType: "other",
            note: "Persuasion communications to secure voting rights delegation from institutional and retail shareholders",
          },
        ],
      },
      {
        side: "target",
        sideLabel: "Young-sook Song & Joo-hyun Lim (Mother-Daughter Alliance, Defense)",
        initials: "HMP",
        bg: "bg-red-600",
        advisors: [
          {
            ...
            role: "Legal Advisory",
            roleType: "legal",
            note: "Board composition defense, OCI merger structure legal review, AGM response management",
          },
          {
            firm: "Financial Advisor (undisclosed)",
            role: "Financial Advisory",
            roleType: "financial",
            note: "OCI Group merger/share exchange structure design and valuation advisory (estimated)",
          },
        ],
      },
    ],
  ...
  valuation: {
    body: "The financial core of the Hanmi Pharmaceutical control dispute is the holding company discount (Hanmi Science) and management risk premium. Hanmi Science trades at a significant discount to the global drug pipeline value of Hanmi Pharmaceutical, and the prolonged dispute is widening this discount. Some analysts value Hanmi Pharmaceutical's key pipelines (obesity, diabetes, anemia drugs) at several trillion won, but management uncertainty is limiting valuation recognition.",
    rows: [
      {
        item: "Hanmi Science Market Cap",
        val: "~KRW 3 Trillion",
        note: "During dispute period",
        accent: true,
      },
      {
        item: "Hanmi Pharmaceutical EV/EBITDA",
        val: "~14x",
        note: "During dispute period (discounted vs. global pharma average)",
      },
      {
        item: "Hanmi Pharmaceutical Annual Revenue",
        val: "~KRW 1.4 Trillion",
        note: "FY2023 (KRW 14,000 billion)",
      },
      {
        item: "Hanmi Pharmaceutical EBITDA",
        val: "~KRW 190 Billion",
        note: "FY2023",
        accent: true,
      },
      {
        item: "Management Risk Discount",
        val: "Estimated 20–30%",
        note: "Risk premium vs. global drug pipeline value",
      },
      {
        item: "Pre-Dispute Share Price",
        val: "₩350,000 (2020)",
        note: "Before founder Sung-ki Lim's passing",
      },
    ],
    disclaimer:
  ...
  rationale: {
    buyer: {
      title: "Jong-yoon Lim Faction's Rationale",
      initials: "JYL",
      bg: "bg-blue-700",
      points: [
    ...
    seller: {
      title: "Song-Lim Alliance's Defense Rationale",
      initials: "HMP",
      bg: "bg-red-600",
      points: [
  ...
  sources: [
    { id: 1, text: "FSS DART — Hanmi Science EGM-related disclosures (2023–2024)" },
    { id: 2, text: "Hanmi Pharmaceutical Annual Reports and IR Materials (2021–2023)" },
    { id: 3, text: "Chosun, Korea Economic Daily, Maeil Business — Hanmi Pharmaceutical control dispute coverage (2021–2025)" },
    { id: 4, text: "Seoul Central District Court — Hanmi Science director appointment injunction rulings (2023–2024)" },
    { id: 5, text: "Hanmi Science AGM result disclosures (March 2023, March 2024), FSS DART" },
  ],

  seo: {
    title: "Hanmi Pharmaceutical Control Dispute — Complete Analysis of the 3-Year Post-Founder Family Battle",
    description:
      "Complete analysis of the Hanmi Pharmaceutical control dispute. Eldest son Jong-yoon Lim vs. mother-daughter alliance, 3-year legal battle, OCI merger controversy, AGM proxy fights. A deep dive into the management vacuum at Korea's leading pharmaceutical company.",
    keywords: [
      "Hanmi Pharmaceutical control dispute",
      "Hanmi Science shareholder meeting",
      "Jong-yoon Lim Joo-hyun Lim dispute",
      "Young-sook Song management",
      "Hanmi OCI merger",
      "Sung-ki Lim succession",
      "Korean pharma governance",
      "founding family dispute",
    ],
  },

  concepts: [
    {
      term: "Founding Family Control Dispute",
      description:
    ...
    {
      term: "Holding Company Voting Rights",
      description:
