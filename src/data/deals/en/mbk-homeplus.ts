...
const deal: DealData = {
  ...
  background: [
    ...
    "[August 2015 final round — a three-way contest.] Tesco's Homeplus sale process advanced to a final round with three bidders: [MBK Partners], [the KKR-Affinity consortium], and [The Carlyle Group]. Carlyle was eliminated early in the final round for submitting a relatively low price, leaving the contest as a [two-way fight between MBK and KKR-Affinity].",
    "[A progressive (sealed-bid escalation) auction.] Rather than a simple final-bid comparison, Tesco ran the sale as a [progressive deal] — the seller sets a price floor and remaining bidders escalate above it in successive rounds. The floor Tesco set was approximately [₩6.7 trillion]. MBK escalated to [₩7.2 trillion], outbidding KKR-Affinity, and was named the sole preferred bidder.",
    "[Michael ByungJu Kim's career and his role at MBK.] MBK Partners' founder is not just \"ex-Goldman.\" His career ran [Goldman Sachs] → [Salomon Smith Barney] → [The Carlyle Group], with his final title before founding MBK being [Chairman of Carlyle Asia]. In 2005, he left Carlyle and co-founded MBK Partners with several Carlyle colleagues. The firm's name — MBK — is taken from his own initials (Michael ByungJu Kim). That said, his actual functional role inside MBK is best described as [a partner specialized in LP relations (Limited Partner Relations)] — he is the ultimate Investment Committee approver, but [not the hands-on lead on individual deals] such as Homeplus. The textbook standard for LBO structuring discipline among global PE firms is generally considered to be [KKR], not MBK.",
    "MBK Partners was founded in 2005 with Mr. Kim's Carlyle colleagues and became a North Asia-focused PE firm with ~$25B in AUM by 2015. With prior Korean LBO wins (ING Life Korea / later Orange Life, C&M Cable TV), MBK out-bid KKR-Affinity in the Homeplus progressive auction to secure preferred-bidder status.",
    "The ₩7.2T headline price was backed by a consortium including Canada Pension Plan Investment Board (CPPIB), which provided equity co-investment. MBK structured the deal with significant leverage — acquisition financing (인수금융) provided by domestic and international banks — with the expectation that a Sale & Leaseback of the store real estate would rapidly deleverage the structure post-close. The transaction set a record as the largest PE deal in Korean history and the largest retail LBO in Asia.",
  ],
  ...
  executiveSummary: [
    ...
    "[Three-way final round → two-way fight → MBK wins.] August 2015 final round saw [MBK / KKR-Affinity / Carlyle]. Carlyle was eliminated early for a low bid, leaving the real contest between [MBK and KKR-Affinity].",
    "[Outcome of a progressive auction.] Tesco ran the sale as a [progressive deal (sealed-bid escalation)] with a ₩6.7T floor; MBK escalated to ₩7.2T to outbid KKR-Affinity and was named sole preferred bidder.",
    "Michael ByungJu Kim's career: [Goldman Sachs] → [Salomon Smith Barney] → [Carlyle Asia Chairman] → founded MBK Partners in 2005. Inside MBK, however, his actual functional role is best described as [a partner specialized in LP relations] — IC ultimate approver but [not the hands-on lead on individual deals] like Homeplus.",
  ...
  faq: [
    {
      q: "Was MBK the original preferred bidder for Homeplus? How did the auction play out?",
      a: "The August 2015 final round had three bidders: [MBK Partners], [the KKR-Affinity consortium], and [The Carlyle Group]. [Carlyle was eliminated early in the final round for submitting a relatively low price], leaving the real contest as a [two-way fight between MBK and KKR-Affinity]. Tesco ran the sale as a [progressive deal] — a sealed-bid escalation auction where the seller sets a price floor and remaining bidders escalate above it. The floor was approximately [₩6.7 trillion]. MBK escalated to [₩7.2 trillion], outbidding KKR-Affinity, and was named sole preferred bidder.",
    },
    {
      q: "What is Michael ByungJu Kim's career background, and did he personally lead the Homeplus deal?",
      a: "Michael ByungJu Kim's career path ran [Goldman Sachs] → [Salomon Smith Barney] → [The Carlyle Group], with his final pre-MBK title being [Chairman of Carlyle Asia]. In 2005 he left Carlyle and co-founded MBK Partners with several Carlyle Asia colleagues — the firm's name comes from his initials (Michael ByungJu Kim). However, inside MBK his actual functional role is best described as [a partner specialized in LP relations (Limited Partner Relations)] — the ultimate Investment Committee approver but [not the hands-on lead on individual deals] like Homeplus. The textbook standard for LBO structuring discipline among global PE firms is generally considered to be [KKR], not MBK.",
    },
    {
      q: "Why did MBK Partners pay 22.5x EBITDA for a hypermarket chain?",
      a: "The high multiple was justified by two factors beyond operating EBITDA: (1) Homeplus owned ~₩4–5T of real estate that could be monetized through Sale & Leaseback — effectively making the operating business much cheaper on an 'ex-real estate' basis; and (2) Tesco's bureaucratic overhead was suppressing margins that MBK expected to recover post-exit. The real estate thesis executed perfectly; the operational thesis did not. The ₩7.2T headline price was also a direct outcome of the progressive deal auction structure, in which MBK needed to outbid KKR-Affinity by enough margin to secure preferred-bidder status.",
    },
    {
