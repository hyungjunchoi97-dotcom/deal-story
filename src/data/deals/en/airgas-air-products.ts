/**
 * Airgas × Air Products Hostile Tender Offer (2010–2011)
 * Textbook Poison Pill & Just Say No Defense · Delaware Court Ruling · Air Liquide Acquires at 2x Price 5 Years Later
 */
...
const deal: DealData = {
  ...
  subtitle: "Board Refuses $70/Share → Air Liquide Buys at $143 Five Years Later · Historic Delaware Ruling · Long-Term Value Judgment Vindicated",
  category: "control",
  ...
  excerpt:
    "Air Products' hostile tender offer for Airgas at $60–$70 per share in 2010–2011. CEO Peter McCausland's categorical refusal, Airgas's poison pill and staggered board defense, the Delaware Court's landmark 'Just Say No is Legal' ruling — and how Air Liquide's $143/share acquisition five years later proved McCausland right. The definitive case study in corporate defense strategy.",
  ...
  dealSummary: {
    ...
    announcedDisplay: "October 2010",
    closedDisplay: "February 2011 (Voluntarily Withdrawn)",
    country: "United States",
  },
  ...
  industryOverview: {
    ...
    players: [
      { name: "Air Products (NYSE: APD)", role: "Hostile acquirer, global industrial gas No. 2" },
      { name: "Airgas (NYSE: ARG)", role: "Acquisition target, U.S. packaged gas No. 1" },
      { name: "Air Liquide (France)", role: "Global No. 1, acquired Airgas at $143/share in 2016" },
      { name: "Praxair (U.S.)", role: "Global No. 2 competitor (now merged with Linde)" },
      { name: "Delaware Court of Chancery", role: "Final ruling authority on poison pill and Just Say No legality" },
    ],
  },

  companyOverview: {
    targetName: "Airgas, Inc.",
    body: "Airgas was founded in 1982 by Peter McCausland and grew to become the No. 1 U.S. packaged gas (cylinder gas) distributor through decades of aggressive bolt-on acquisitions of smaller gas distributors. It supplied a wide range of industrial gases — oxygen, nitrogen, argon, carbon dioxide, helium, acetylene — to more than 11,000 customers across the United States. In 2010, it employed approximately 14,000 people and operated more than 450 distribution locations, a robust business model. McCausland's founder leadership and long-term value-oriented management philosophy were the core of the defense in this deal.",
    metrics: [
      { label: "Founded", value: "1982", sub: "Peter McCausland, founder-CEO" },
      { label: "U.S. Packaged Gas Market Share", value: "~30%", sub: "U.S. No. 1 distributor" },
      { label: "Annual Revenue", value: "~$3B", sub: "2010" },
      { label: "Employees / Distribution Locations", value: "~14,000 / 450+", sub: "2010" },
    ],
    financials: [
      {
        year: "FY2010",
  ...
  controlBattleOverview: {
    body: "Air Products' hostile tender offer for Airgas is a landmark in U.S. corporate governance history. This analysis traces how the poison pill and staggered board actually worked in practice, and how the board that refused a seemingly generous premium was vindicated five years later.",
    catalyst: "Industrial gas market consolidation opportunity — Air Products seeks to acquire U.S. No. 3 gas company to strengthen market position",
    ...
    battleMoves: [
      {
        ...
        actor: "Air Products",
        side: "attack",
        move: "Initial Private Proposal — $60/Share",
        detail:
        ...
        weapon: "Private Pre-emptive Proposal",
      },
      {
        date: "2010-10-04",
        actor: "Air Products",
        side: "attack",
        move: "Public Hostile Tender Offer Launched — $60/Share",
        detail:
        ...
        financialImpact: "Airgas shares +30%",
      ...
      },
      {
        ...
        actor: "Airgas",
        side: "defense",
        move: "Poison Pill + Staggered Board Activated",
        detail:
      ...
      },
      {
        ...
        actor: "Air Products",
        side: "attack",
        move: "Final Offer — $70/Share, Total ~$5.9B",
        detail:
        ...
        financialImpact: "Total offer ~$5.9B",
        weapon: "Final Price Escalation",
      },
      {
        date: "2011-02-15",
        actor: "Delaware Court of Chancery",
        side: "neutral",
        move: "Landmark Ruling: Poison Pill Legal, Just Say No Defense Permitted",
        detail:
        ...
        weapon: "Delaware Court Ruling",
      },
      {
        date: "2011-02-11",
        actor: "Air Products",
        side: "neutral",
        move: "Tender Offer Voluntarily Withdrawn — Airgas Defense Succeeds",
        detail:
        ...
        financialImpact: "Airgas shares -10% (premium evaporates)",
    ...
    financialWeapons: [
      {
        ...
        side: "defense",
        usedBy: "Airgas Board of Directors",
        description:
      ...
      },
      {
        ...
        side: "defense",
        usedBy: "Peter McCausland / Airgas Board",
        description:
    ...
    turningPoint: {
      date: "2011-02-15",
      event: "Delaware Court Ruling — Poison Pill and Just Say No Legally Confirmed",
      detail:
    ...
    verdict: {
      ...
      note: "McCausland's refusal of the 'low offer' was proven correct: Air Products withdrew at $70 → Air Liquide acquired at $143 five years later (2x Air Products' offer). The board's long-term value judgment delivered greater returns to shareholders.",
    },
    priceImpact: {
      preContest: "$43 (before Air Products public offer, October 2010)",
      peak: "$70 (Air Products final offer)",
      postContest: "$60–65 (after February 2011 withdrawal)",
      note: "Five years later, in 2016, Air Liquide acquired Airgas at $143/share — 2x Air Products' $70 offer. McCausland was right.",
    },
  },

  dealStructure: {
    body: "Air Products proposed a full-cash tender offer to Airgas shareholders at $70/share. However, Airgas's poison pill (20% trigger) made it economically impossible for Air Products to acquire 20%+ without board approval. The staggered board required 3 years for a full board replacement. Following the Delaware court ruling, Air Products withdrew, and Airgas maintained its status as an independent public company. Subsequently, in 2016, Air Liquide completed a friendly acquisition at $143/share.",
    preOwnership: {
      nodes: [
        {
          id: "apd",
          label: "Air Products (APD)",
          sub: "NYSE listed, hostile offer in progress",
          type: "acquirer",
        },
        {
          id: "mccausland",
          label: "Peter McCausland / Board",
          sub: "Founder-CEO, leading defense",
          type: "entity",
        },
        {
          id: "public_shareholders",
          label: "Airgas Public Shareholders",
          sub: "Voting casting votes",
          type: "public",
        },
        {
          id: "airgas",
          label: "Airgas, Inc.",
          sub: "NYSE: ARG listed company",
          type: "target",
        },
      ],
      edges: [
        { from: "apd", to: "airgas", label: "Hostile tender offer ($70/share)" },
        { from: "mccausland", to: "airgas", label: "CEO & board leading defense" },
        { from: "public_shareholders", to: "airgas", label: "Public shareholder stake" },
      ],
    },
    postOwnership: {
      nodes: [
        {
          id: "apd_withdrew",
          label: "Air Products (APD)",
          sub: "Voluntarily withdrew February 2011",
          type: "acquirer",
        },
        {
          id: "airgas_independent",
          label: "Airgas, Inc.",
          sub: "Independence maintained → Air Liquide acquisition 2016",
          type: "target",
        },
        {
          id: "air_liquide",
          label: "Air Liquide (France)",
          sub: "Friendly acquisition at $143/share, 2016",
          type: "fund",
        },
      ],
      edges: [
        {
          ...
          label: "Acquisition failed · withdrew",
        },
        {
          from: "air_liquide",
          to: "airgas_independent",
          label: "2016 acquisition at $143/share completed",
        },
      ],
    },
    keyTerms: [
      { label: "Initial Offer", value: "$60/share", accent: false },
      { label: "Final Offer", value: "$70/share (total ~$5.9B)", accent: true },
      { label: "Deal Type", value: "All-Cash Hostile Tender Offer" },
      { label: "Poison Pill Trigger", value: "20%+ stake acquisition" },
      { label: "Delaware Court Ruling", value: "Poison pill legal + Just Say No permitted (Feb 15, 2011)" },
      { label: "Outcome", value: "Air Products voluntarily withdrew (Feb 11, 2011)" },
      { label: "Five Years Later", value: "Air Liquide acquires at $143/share ($13.4B), 2016", accent: true },
    ],
  },

  advisors: {
    body: "This deal mobilized Wall Street's top investment banks and Delaware specialist law firms in an epic hostile tender offer battle. With court litigation as the decisive arena, Delaware corporate law specialists played an especially critical role.",
    sides: [
      {
        side: "acquirer",
        sideLabel: "Air Products (Hostile Acquirer)",
        initials: "APD",
        bg: "bg-blue-700",
        advisors: [
          {
            ...
            roleType: "financial",
            note: "Tender offer structure design, pricing, and shareholder communication management",
          },
          {
            firm: "Wachtell, Lipton, Rosen & Katz",
            role: "Legal Advisor",
            roleType: "legal",
            note: "Hostile tender offer legal structure and Delaware litigation strategy",
          },
        ],
      },
      {
        side: "target",
        sideLabel: "Airgas (Defense)",
        initials: "ARG",
        bg: "bg-orange-600",
        advisors: [
          {
            ...
            role: "Financial Advisor",
            roleType: "financial",
            note: "Defense strategy structuring, standalone valuation, fairness opinion",
          },
          {
            firm: "Cravath, Swaine & Moore",
            role: "Legal Advisor",
            roleType: "legal",
            note: "Poison pill defense strategy and Delaware Court of Chancery litigation management",
          },
          {
            firm: "Richards, Layton & Finger",
            role: "Legal Advisor (Delaware Local)",
            roleType: "legal",
            note: "Delaware Court of Chancery local counsel",
          },
        ],
      },
    ],
  ...
  valuation: {
    body: "Air Products' final offer of $70/share represented a 63% premium to Airgas's pre-offer share price of $43, and approximately 10x EV/EBITDA. The Airgas board judged this price as 'undervaluation that fails to reflect future growth value and operational improvement potential' and rejected it. The judgment was ultimately vindicated five years later when Air Liquide acquired Airgas at $143/share.",
    rows: [
      {
        item: "Air Products Initial Offer",
        val: "$60/share",
        note: "February 2010 private proposal",
      },
      {
        item: "Air Products Final Offer",
        val: "$70/share (total $5.9B)",
        note: "January 2011; 63% premium to pre-offer share price",
        accent: true,
      },
      {
        item: "Pre-Offer Share Price",
        val: "$43/share",
        note: "October 2010 baseline",
      },
      {
        item: "EV/EBITDA (At Offer Price)",
        val: "~10x",
        note: "$5.9B / EBITDA ~$600M",
        accent: true,
      },
      {
        item: "Air Liquide Acquisition Price (2016)",
        val: "$143/share ($13.4B)",
        note: "2016 — exactly 2x Air Products' $70 offer",
        accent: true,
      },
      {
        item: "McCausland's Implied Prediction Premium",
        val: "+104%",
        note: "Rejecting Air Products $70 → Air Liquide delivers $143",
      },
    ],
    disclaimer:
  ...
  rationale: {
    buyer: {
      title: "Air Products' Acquisition Rationale",
      initials: "APD",
      bg: "bg-blue-700",
      points: [
    ...
    seller: {
      title: "Airgas's Defense Rationale (McCausland)",
      initials: "ARG",
      bg: "bg-orange-600",
      points: [
  ...
  tombstone: {
    ...
    closeDate: "Feb 2011 (Withdrawn)",
  },

  sources: [
    { id: 1, text: "Air Products SEC 14D-9 / TO-T filings — Hostile Tender Offer for Airgas (2010–2011)", url: "https://www.sec.gov" },
    { id: 2, text: "Delaware Court of Chancery, Air Products and Chemicals, Inc. v. Airgas, Inc. — Judge William B. Chandler III Opinion (February 15, 2011)" },
    { id: 3, text: "Airgas SEC 14D-9 — Board of Directors' Recommendation Against Air Products Offer (2010–2011)" },
    { id: 4, text: "Wall Street Journal — Air Products Abandons Airgas Bid (February 2011)" },
    { id: 5, text: "Air Liquide Press Release — Acquisition of Airgas at $143.00 per share ($13.4B) (March 2016)" },
    { id: 6, text: "Harvard Law School Forum on Corporate Governance — The Airgas Case and the Future of Poison Pills (2011)" },
  ],

  seo: {
    title: "Airgas vs Air Products Complete Analysis — The Textbook Poison Pill & Just Say No Defense",
    description:
      "Complete analysis of Air Products' hostile tender offer for Airgas. How the poison pill and staggered board work in practice, the Delaware Court's landmark Just Say No ruling, and how Air Liquide's $143/share acquisition five years later proved McCausland right.",
    keywords: [
      "Airgas Air Products hostile takeover",
      "poison pill how it works",
      "Just Say No defense",
      "staggered board defense",
      "Delaware Court of Chancery ruling",
      "corporate defense strategy",
      "McCausland Airgas",
      "Air Liquide Airgas acquisition",
    ],
  },
