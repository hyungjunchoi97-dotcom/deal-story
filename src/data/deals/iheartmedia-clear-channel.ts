...
const deal: DealData = {
  ...
  postDealAssessment: {
    ...
    editorNote: "Clear Channel LBO의 가장 중요한 교훈은 두 가지다. 첫째, 피크 가격에 약정된 레버리지드론은 '시장 플렉스'만으로 감당이 안 될 경우 은행이 손실을 보게 된다. 둘째, Debt/EBITDA 13×라는 극단적 레버리지는 산업 구조가 바뀌지 않아도 이자만으로 기업을 죽일 수 있다. LevFin 애널리스트들이 이 딜을 'Credit Metrics의 반면교사'로 사용하는 이유가 여기 있다.",
  },
