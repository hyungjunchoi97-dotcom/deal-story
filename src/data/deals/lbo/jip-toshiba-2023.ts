...
const deal: LboDeal = {
  ...
  tombstone: {
    ...
    fundNameEn: "Japan Industrial Partners Consortium",
    portfolioName: "도시바 주식회사",
    portfolioNameEn: "Toshiba Corporation",
    dealTitle: "JIP × 도시바 — 일본 사상 최대 ¥2조 MBO",
    dealTitleEn: "JIP × Toshiba — Japan's Largest-Ever ¥2T MBO",
    dealSize: "¥2T / ~$14B EV",
    entryMultiple: "8.75× EBITDA",
    holdYears: "진행 중",
    holdYearsEn: "Ongoing",
    closeDate: "2023년 12월 20일",
    closeDateEn: "Dec 20, 2023",
  },
