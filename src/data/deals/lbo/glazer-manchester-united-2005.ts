...
const deal: LboDeal = {
  ...
  lboMetrics: {
    ...
    capitalStructure: [
      ...
      },
      {
        ...
        rateEn: "8.375% Fixed (GBP) / 8.75% (USD)",
        maturity: "7년",
        maturityEn: "7yr",
        color: "bg-violet-600",
      },
  ...
  tombstone: {
    ...
    dealTitleEn: "Glazer × Manchester United — £790M Sports LBO",
    dealSize: "£790M EV (~$1.4B)",
    entryMultiple: "10× EBITDA",
    moic: "~5×",
    irr: "~9%",
    holdYears: "20년+ (현재진행)",
    holdYearsEn: "20+ yrs (ongoing)",
    closeDate: "2005년 6월 30일",
    closeDateEn: "Jun 30, 2005",
  },
