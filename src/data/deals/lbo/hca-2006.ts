...
const deal: LboDeal = {
  ...
  tombstone: {
    ...
    fundNameEn: "KKR + Bain + Merrill Consortium",
    portfolioName: "Hospital Corporation of America",
    dealTitle: "KKR·Bain·Merrill × HCA — $33B 메가LBO와 CLO 투자자",
    dealTitleEn: "KKR·Bain·Merrill × HCA — A $33B Mega-LBO Through CLO Eyes",
    dealSize: "$33B EV",
