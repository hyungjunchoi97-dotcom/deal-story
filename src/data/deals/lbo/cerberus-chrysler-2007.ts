...
const deal: LboDeal = {
  ...
  tombstone: {
    ...
    dealTitleEn: "Cerberus × Chrysler — A $7.4B LBO Wiped Out in 24 Months",
    dealSize: "$7.4B 에쿼티 / ~$19B EV",
    dealSizeEn: "$7.4B Equity / ~$19B EV",
    entryMultiple: "n/m (마이너스 EBITDA)",
    entryMultipleEn: "n/m (negative EBITDA)",
    moic: "0.0×",
    irr: "-100%",
    holdYears: "2년",
    holdYearsEn: "2 yrs",
    closeDate: "2007년 8월 3일",
    closeDateEn: "Aug 3, 2007",
  },
