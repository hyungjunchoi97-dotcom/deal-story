  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    blocks: [
      ...
      },
      {
        type: "metrics",
        items: [
          { label: "MBK 홈플러스 인수가", labelEn: "MBK Homeplus deal", value: "7.2조원 (2015)", valueEn: "₩7.2T (2015)", sub: "인수금융 약 4.3조원 (59.8%)", subEn: "~₩4.3T acq-fin (59.8%)", color: "text-red-500" },
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          variant: "insight",
          heading: "비유 1, 은행 대출 vs PC",
          headingEn: "Analogy 1 — Bank Loan vs PC",
          body:
            "은행 대출은 백화점 매대다.\n\n진열대가 정해져 있고, 약관도 표준화되어 있고, 누구나 볼 수 있다.\n\nPC는 동네 부자 아저씨의 직접 대출에 가깝다.\n\n조건은 상대방을 보고 협상하고, 약관은 거래마다 다시 쓴다.\n\n영어권 비유로 옮기면 the wealthy uncle down the street, lending out of his own pocket이다.\n\n한 사람이 직접 본다는 점이 핵심이다.",
          bodyEn:
      ...
      },
      {
        ...
        callout: {
          variant: "insight",
          heading: "비유 2, BSL vs PC",
          headingEn: "Analogy 2 — BSL vs PC",
          body:
            "BSL(Broadly Syndicated Loan, 광범위 신디케이트 대출)은 공동구매다.\n\nJP Morgan이 한 거래를 주선하면 50-100개 기관이 조각으로 나눠 산다.\n\nPC는 맞춤 정장이다.\n\nBlue Owl이 단독 또는 3-4개 club deal로 한 회사를 끝까지 hold한다.\n\n영어로 적으면 BSL = Costco bulk pack, PC = bespoke tailor다.\n\n가격, 약관, hold 기간이 전부 다르다.",
          bodyEn:
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["약관", "표준화", "Cov-Lite 93%", "Cov-Lite 약 21% (2024-25, 상승 중)"],
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "PC AUM 자체가 source마다 다르다.\n\nPreqin 협의 정의는 2024년 $1.7T, BIS 광의 정의는 $2.1T, JPM, PitchBook 보수 정의는 $1.2T이다.\n\n본문에서 단일 숫자를 인용할 땐 Preqin 협의 기준으로 통일했다.\n\n다른 소스를 인용할 땐 명시한다.",
          bodyEn:
    ...
    blocks: [
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "Source: Preqin Private Debt AUM (dry powder 포함). 광의 정의 시 2024년 약 $2.1T(BIS), 보수 정의 시 약 $1.2T(JPM). 본 차트는 Preqin 협의 기준이다.",
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "$1.7T의 절반 가까이는 보험사 GA에서 왔다.\n\nApollo가 Athene을 통해, KKR이 Global Atlantic 100% 인수를 통해, Brookfield가 American Equity Life를 통해, Blackstone이 Corebridge, Allstate, Resolution Life SMA(Separately Managed Account)를 통해 연금 부채(평균 듀레이션 7-10년)를 long-dated PC 자산과 매칭했다.\n\n즉 PC 성장의 자금원은 retail이 아니라 보험, 연금 long money가 본체다. (→ ✓11)",
          bodyEn:
    ...
    blocks: [
      ...
      },
      {
        ...
        table: {
          ...
          highlightRows: [6],
          caption: "Source: BIS Basel III phase-in arrangements. G-SIB은 추가 1-3.5% buffer를 부담한다. 2019년 최종 단계에서 은행은 자본을 모으느라 변두리 leverage 거래를 포기했다.",
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "Source: PitchBook LCD, Proskauer, JPM 종합 (중소, 중견 LBO 한정). 메가딜(>$3B)은 여전히 BSL 우세다. 2022년 PC 비중 60%는 금리 급등으로 BSL 시장이 stall한 결과이며, 일시 효과이다.",
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "2025년 12월 5일, OCC와 FDIC가 2013 Interagency Leveraged Lending Guidance에서 withdraw했다 (트럼프 2기 deregulation, Fed는 잔류).\n\n12년간 PC를 키운 규제 한 축이 끊겼다.\n\n단기 효과는 은행이 6배+ 거래로 다시 들어올 수 있다는 것, PC와 직접 경쟁 가능성이다.\n\n이 단 한 줄이 2026년 PC 가격 압박의 시작점이다.⁹",
          bodyEn:
    ...
    blocks: [
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "Source: Preqin + McKinsey 종합. 운용사별 분류 차이로 ±5% 오차가 있다. Direct Lending이 단일 최대 자산군이고, ABF가 가장 빠르게 성장 중이다.",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ["Finastra unitranche", "2023", "약 $5B", "Blue Owl, Oak Hill, HPS, Sixth Street", "사상 최대 unitranche"],
            ["New Relic ($6.5B LBO)", "2023", "약 $2.7B+ unitranche", "Blue Owl, Blackstone, Sixth Street", "Francisco Partners + TPG 인수"],
            ["Cotiviti", "2024", "약 $5.5B PC 패키지", "Blackstone 등", "Carlyle 인수금융"],
            ["Squarespace", "2024", "약 $2.6B PC 패키지", "Blackstone 등", "Permira 인수금융"],
          ],
          rowsEn: [
          ...
          highlightRows: [0],
          caption: "Sources: LSTA 2024 Direct Lending Review, Proskauer. Highlight = Finastra: 최초로 PC 컨소시엄이 메가딜 BSL 시장을 직접 대체한 사건이다.",
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "\"Direct lending이 소프트웨어 LBO에 집중된 점이 우려된다. 약 20x EBITDA로 인수된 회사들, 이는 미래 EBITDA 성장이 반드시 일어나야만 정당화되는 가격이다. AI가 소프트웨어 가치를 disrupt 한다면, 그리고 그 가능성은 결코 0이 아닌데, PC 채권자가 가장 먼저 손실을 본다.\"\n\nMarks는 systemic risk라 부르지 않는다.\n\nconcentrated risk라고 부른다.\n\n차이가 중요하다.",
          bodyEn:
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "\"credit carelessness는 있다. 그러나 systemic은 아니다.\"\n\n이 한 문장이 Marks의 최종 입장이다.\n\n2024년 \"Gimme Credit\"의 buy-case와 2025년 software LBO 우려를 양손에 들고, 결론은 \"방심은 보이지만 시스템은 안전하다\"로 정리됐다.\n\nPC 시장의 가장 영향력 있는 운용사가 경계는 하되 panic하지 않는다는 입장을 명확히 한 셈이다.¹³",
          bodyEn:
    ...
    blocks: [
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "Source: Apollo IR / Marc Rowan outlook. 광의 정의 (auto, aviation, consumer, receivables 포함). 2030 $40T는 Apollo 자체 outlook으로 매우 공격적이다. PC 펀드 보유분은 시장 전체의 약 10%대이다.",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ["Apollo × PayPal BNPL", "2023", "최대 약 $40B 약정", "Forward Flow 매입", "Apollo (Athene)"],
            ["Apollo × Intel 아일랜드 fab JV", "2024", "$11B financing", "JV 구조 (ABF + equity)", "Apollo"],
            ["KKR × Discover 학자금", "2024.7", "약 $10.1B", "포트폴리오 매입", "KKR"],
          ...
          caption: "Sources: Apollo IR, KKR IR, Blue Owl IR. SRT(Significant Risk Transfer) 거래도 ABF의 일부이며, 은행이 자기 portfolio risk를 PC에 양도하는 구조로 2023-24년 급증했다.",
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "Vista Equity Partners는 Vista Outcomes Fund의 NAV를 담보로 대출을 받아 LP에게 배당(dividend recap)을 실행했다.\n\n이미 손실 위험이 있는 portfolio에 leverage를 추가해 LP 입장에서 risk-adjusted return을 악화시킨다는 비판이 거셌다.\n\nILPA(Institutional Limited Partners Association, 기관 LP 협회)는 2024년 NAV financing 가이드라인을 발간하며 LP 사전 동의 필수를 권고했다.\n\n이 한 사건이 NAV finance 전체에 LP 불신이라는 그림자를 남겼다.¹⁷",
          bodyEn:
