...
export const SECTIONS_PART_A: NoteSection[] = [
  // ════════════════════════════════════════════════════════════════
  // 1. Hook — 한국 안에서도 사이클이 갈렸다
  // ════════════════════════════════════════════════════════════════
  {
    heading: "1. 한국 안에서도 사이클이 갈렸다",
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "2022년 ChatGPT 공개, 2023년 엔비디아 H100 폭발, 2024년 반도체 전체 사이클 회복, 2025년 HBM 시장 본격 폭발, 2026년 1조달러 시장 마일스톤.\n\n이 흐름 안에서 한국 반도체가 어디에 있는지는 다음 §3 밸류체인 지도에서 풀어낸다.",
          bodyEn:
    ...
    blocks: [
      ...
      },
      {
        ...
        chart: {
          ...
          stages: [
            ...
            { id: "s3", label: "3. 설계 (Fabless)", labelEn: "3. Design (Fabless)", companies: "엔비디아, AMD, 브로드컴, 마벨, 미디어텍", companiesEn: "NVIDIA, AMD, Broadcom, Marvell, MediaTek", koreaExposure: "low" },
            { id: "s4", label: "4. 파운드리", labelEn: "4. Foundry", companies: "TSMC, 삼성, 인텔, SMIC, UMC", companiesEn: "TSMC, Samsung, Intel, SMIC, UMC", koreaExposure: "medium" },
      ...
      },
      {
        ...
        table: {
          ...
          highlightRows: [10],
          caption: "출처: 각 사 2025~2026년 1분기 IR 종합. 엔비디아, SK하이닉스, TSMC, ASML이 영업이익률 35%+ 영역. 같은 산업 안에서도 어느 단계를 잡았느냐가 영업이익률 5~7배 차이를 만든다.",
  ...
  // ════════════════════════════════════════════════════════════════
  {
    heading: "4. Fabless 설계사 매핑, 엔비디아, AMD, 브로드컴, 마벨, 미디어텍",
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "엔비디아만 보면 브로드컴의 ASIC 수주잔고 730억달러를 놓친다.\n\n그 수주잔고는 하이퍼스케일러가 엔비디아에서 자체 칩으로 옮겨가고 있다는 신호다.\n\n그 흐름 안에서 진짜 알파는 둘 다 의존하는 공급망, TSMC CoWoS, SK하이닉스 HBM, ASML EUV다.",
          bodyEn:
  ...
  // ════════════════════════════════════════════════════════════════
  {
    heading: "5. 메모리 사이클, HBM이 일반 디램을 잡아먹는다",
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          variant: "warning",
          heading: "HBM이 일반 디램을 잡아먹는 메커니즘",
          headingEn: "The Mechanism: HBM Cannibalizing General DRAM",
          body:
            "SK하이닉스 웨이퍼 한 장은 HBM 또는 DDR5를 만들 수 있다.\n\nHBM 한 스택은 일반 디램 칩보다 웨이퍼 면적을 약 4배 차지한다.\n\n같은 웨이퍼로 HBM을 만들수록 일반 디램 공급이 줄어든다.\n\n26년 1분기 결과는 명확하다.\n\n26년 1분기 CNBC 보도, 일반 디램이 공급 부족.\n\n한국 반도체에 의미하는 것은 두 가지다.\n\n첫째, SK하이닉스와 삼성의 메모리 부문 평균 영업이익률이 사상 최고 영역으로 진입한다.\n\n둘째, DDR5를 쓰는 서버, PC, 스마트폰 OEM이 메모리 조달 비용 폭증으로 영업이익이 압박받는다.",
          bodyEn:
      ...
      },
      {
        ...
        table: {
          id: "ddr5-spot",
          title: "DDR5 8Gb 현물 가격 추세",
          titleEn: "DDR5 8Gb Spot Price Trend",
          headers: ["분기", "DDR5 8Gb 현물 ($)", "비고"],
          ...
          caption: "출처: TrendForce, DRAMeXchange, 보도 종합. 현물은 변동 크고 정의 차이.",
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "HBM 사이클이 언제 꺾이는가가 가장 큰 변수다.\n\n26년 현재는 HBM 공급 부족 국면이다.\n\n그러나 27년~ 공급 과잉 시나리오가 SemiAnalysis와 Jim Chanos(공매도 전문)에서 나오고 있다.\n\nSK하이닉스, 삼성, 마이크론 셋 다 HBM4 캐파 확장을 발표.\n\n엔비디아 Rubin, AMD MI400 출하량이 기대만큼 안 늘어나면, HBM 공급이 수요를 초과할 수 있다.\n\n이 시나리오는 §15 위험 신호에서 자세히 본다.",
          bodyEn:
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "TSMC의 압도는 몇 년 안에 깨지지 않는다.\n\n이유는 세 가지다.\n\n첫째, 첨단 노드 진입 비용이 fab 1개당 200억달러+로 폭증했다.\n\n둘째, 같은 노드를 같은 수율로 만들려면 수년의 학습 곡선이 필요하다.\n\n셋째, 고객이 옮기지 않는다. 엔비디아, AMD, 애플, 퀄컴이 TSMC를 떠날 이유가 없다.\n\n이게 §14에서 다룰 TSMC가 엔비디아의 캐파를 결정하는 메커니즘의 출발점이다.",
          bodyEn:
  ...
  // ════════════════════════════════════════════════════════════════
  {
    heading: "7. 중국의 추격, 5년 안에 따라잡힐 수도",
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "세 가지로 압축된다.\n\n첫째, 일반 디램(DDR5, LP5)은 5년 안에 중국과 가격 경쟁에 들어간다. 이게 SK하이닉스, 삼성의 메모리 매출의 약 30~40%다.\n\n둘째, 낸드는 이미 위협받고 있다. YMTC가 가격 덤핑에 가까운 전략을 쓰면 삼성 낸드 영업이익이 사라질 수 있다.\n\n셋째, HBM과 EUV는 5~10년 안전 영역이다. 이 두 영역에 박힌 한국 회사들, SK하이닉스 HBM, 한미반도체 TC Bonder, 솔브레인 인산 식각, HPSP 고압 어닐링이 상대적으로 더 안전하다.",
          bodyEn:
  ...
  // ════════════════════════════════════════════════════════════════
  {
    heading: "8. 3대 병목 1, HBM 그리고 SK하이닉스가 잡은 새 사이클",
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "SK하이닉스 영업이익률 72%가 지속 가능한가가 가장 큰 변수다.\n\nHBM 시장은 26년 현재 공급 부족 국면이지만 공급 측에서도 셋(SK, 삼성, 마이크론) 모두 캐파 확장이다.\n\n27년~ 공급 과잉 시나리오가 SemiAnalysis와 Jim Chanos에서 나오고 있다.\n\n이건 §15 위험 신호에서 자세히 본다.",
          bodyEn:
  ...
  // ════════════════════════════════════════════════════════════════
  {
    heading: "9. 3대 병목 2, CoWoS와 TSMC가 엔비디아의 캐파를 결정한다",
    ...
    blocks: [
      ...
      },
      {
        ...
        callout: {
          variant: "example",
          heading: "24~25년 엔비디아 Blackwell 지연, CoWoS가 진짜 변수였다",
          headingEn: "2024-25 NVIDIA Blackwell Delay — CoWoS Was the Real Variable",
          body:
            "2024년 4월 엔비디아 Blackwell 발표.\n\n24년 4분기 양산 예고였지만 몇 차례 지연.\n\n표면적 이유는 Blackwell 자체의 설계 결함으로 알려졌다.\n\n실제로는 CoWoS 캐파 부족이 더 큰 변수였다는 것이 SemiAnalysis(Dylan Patel)의 분석이다.\n\nTSMC가 엔비디아, AMD, 브로드컴, 마벨, 애플 사이에서 CoWoS 캐파를 배분해야 했고, 엔비디아가 모든 물량을 받지 못했다.\n\n결과적으로 25년 1분기 양산으로 늦춰졌고, 그 사이 AMD MI300X가 일부 시장을 가져갔다.",
          bodyEn:
      ...
      },
      {
        ...
        table: {
          ...
          caption: "CoWoS에서 한국 노출은 상대적으로 제한적이다. ABF substrate를 일본 아지노모토가 사실상 100% 점유하고, underfill 소재도 일본 강자. 한국 노출은 식각 챔버 부품과 슬러리에 머문다.",
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "TSMC가 캐파로 통제한다는 메커니즘은 §14 케이스 스터디에서 더 깊이 본다.\n\n핵심은 엔비디아, AMD, 브로드컴 셋이 같이 줄을 서면 TSMC가 누구에게 얼마를 줄지 결정하는 위치에 있다는 것이다.\n\nCoWoS는 엔비디아만의 병목이 아니라 AI 칩 시장 전체의 병목이다.",
          bodyEn:
