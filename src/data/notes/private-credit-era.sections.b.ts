    ...
    blocks: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ["Apollo", "약 $751B", "약 $598B", "Athene + Athora", "합병형", "ABF, IG PC, Distressed"],
            ["Blackstone", "약 $1.1T (C&I $375.5B)", "약 $375B (C&I)", "Corebridge, Allstate (SMA)", "위탁형", "Large-cap unitranche, Infra debt"],
            ["KKR", "약 $638B", "약 $240B", "Global Atlantic (100%)", "100% 인수", "Leveraged credit, ABF"],
            ["Ares", "약 $484B", "약 $199B (DL)", "Aspida", "합작형", "Direct lending 1위, NAV lending"],
            ["Blue Owl", "약 $235B", "약 $235B", "Kuvare AM (2024 인수)", "멀티 플랫폼", "Upper-MM unitranche, GP financing"],
            ["Oaktree", "약 $205B", "(대부분)", "American Equity Life (Brookfield)", "distressed 전통", "Distressed, HY, Opportunity"],
            ["HPS", "약 $165B (2025.6)", "(전체)", "(직접 보유 없음)", "specialty", "Junior, mezz, Large-cap DL"],
            ["Sixth Street", "약 $75B", "(대부분)", "(없음)", "cross-platform", "Sports media, Growth credit"],
          ],
          rowsEn: [
          ...
          caption: "출처: 각사 IR 2024 Q4, 2025 H1. AUM 정의는 회사별 상이 (Apollo \"Direct Origination + ABF\" 합계 vs Ares \"Direct Lending\" 단독). Sixth Street은 2020년 TPG에서 분사했다. 2025.7 BlackRock의 HPS 인수 완결로 BlackRock 통합 PC franchise는 약 $220B다.²¹",
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "출처: Preqin + McKinsey 종합. 운용사별 분류 차이로 ±5% 오차. Direct Lending이 시장의 약 절반을 차지한다는 점이 핵심이다.",
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "AUM은 약 $75B로 빅 7보다 작지만 cross-platform thematic 전략이 독특하다.\n\nReal Madrid, FC Barcelona의 미디어 라이선스 financing, Airbnb pre-IPO convertible, 스포츠팀 지분 financing 등이 대표적이다.\n\n2020년 TPG에서 분사한 이후 deal-by-deal 색깔이 강하다.\n\n빅 7과 같은 \"flow business\"가 아니라 event-driven에 가깝다.\n\n→ ✓13에서 다시 등장한다.²²",
          bodyEn:
    ...
    blocks: [
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "Source: Apollo IR 2024, Athene 10-K. 단계별 마진은 Apollo 자체 추정 수준이며 실제 spread는 vintage, duration, credit mix에 따라 변동된다.",
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "출처: 각 운용사 IR 2024 Q4. 보험사 GA(General Account) 자산과 PC 운용 AUM 정의가 회사별로 상이하다 (±10% 오차). Apollo 보험사 자산은 Athene 단독, KKR은 Global Atlantic 100%, Blue Owl은 Kuvare 인수분 기준이다.",
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "NAIC(전미보험감독관협회)는 2024년 RBC(Risk-Based Capital) framework 강화안에서 affiliated investment에 추가 자본 charge를 검토했다.\n\nCLO equity, BDC 지분 등 illiquid 자산 보유 한도, Bermuda 재보험사로의 위험 이전(특히 Athene, Global Atlantic, Resolution Life 패턴)에 대한 Bermuda Working Group까지 출범했다.\n\nBoE는 2024년 11월 FSR에서 \"PE firms owning life insurers\"를 systemic risk로 명시했다.\n\n우려 메커니즘은 단순하다.\n\n보험 연금 부채 → illiquid PC로 운용 → 시장 충격 시 자산 매도 어려움 → 폴리시홀더 손실 가능성이다.\n\n2025년 BoE의 SWES(System-Wide Exploratory Scenario)에 private markets가 포함된 것은 이 우려의 공식화다.²⁴",
          bodyEn:
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["2021 / 2024.1", "KKR × Global Atlantic", "63% (2021) → 100% (2024.1, $2.7B)", "GA AUM 약 $158B", "인수형의 표본"],
            ["2022.9", "Blackstone × Corebridge", "SMA 위탁", "초기 약 $50B → 5년 $92.5B 한도", "지분 없는 위탁형"],
            ["2020", "Ares × Aspida", "합작 출범", "2024 신규자본 약 $1B 투입", "합작형"],
            ["2024", "Blue Owl × Kuvare AM", "인수", "약 $20B AUM", "멀티 플랫폼"],
            ["2024", "Brookfield × American Equity Life", "인수", "약 $70B", "Oaktree 모회사 통합"],
          ],
          rowsEn: [
          ...
          caption: "출처: 각사 보도자료, SEC 8-K, BSIC. Bermuda 재보험을 통한 capital relief 구조는 NAIC, BoE 우려의 공통 분모다.",
    ...
    blocks: [
      ...
      },
      {
        ...
        chart: {
          ...
          title: "Chart 6, 한국 인수금융 주선 상위 기관 (2024, 조원)",
          titleEn: "Chart 6 — Korea Acquisition Finance League Table 2024 (₩T)",
          caption: "출처: thebell League Table 2024. 삼성증권은 상반기 1위였으나 연간 수치 별도 cross-check가 필요해 표에서 제외했다. 외국계 (Apollo, KKR, PAG)는 공동 주관 형태로 일부 참여했다.",
      ...
      },
      {
        ...
        chart: {
          id: "korea-pc-markets",
          title: "Chart 7, 한국 인수금융, NPL, 부동산 PF 추이 (조원)",
          titleEn: "Chart 7 — Korean Acq. Finance · NPL · PF Markets (₩T)",
          caption: "출처: thebell, 블로터, 금융위, 삼일PwC 종합. 2018-2022 인수금융은 보도 추정치다. 부동산 PF는 2024년 정상화로 일부 감소했다.",
      ...
      // ── 12-4 K-BDC ─────────────────────────────────────
      {
        ...
        callout: {
          ...
          body:
            "한국은 미국형 BDC가 아직 없다.\n\n2024-2025년 자본시장법 개정 논의에서 K-BDC 도입과 일반 투자자의 PEF 출자 한도 완화가 주요 의제로 올라왔다.\n\n현재 한국에서 글로벌 PC에 접근하는 경로는 두 가지다.\n\n첫째, 미래에셋, 삼성자산운용 등의 BDC ETF (미국 BDC index 추종).\n\n둘째, 사모재간접펀드 형태로 ARCC, OBDC, BCRED 간접 노출이다.\n\n단, 정확한 AUM, 티커는 cross-check가 필요한 영역이다.²⁸",
          bodyEn:
      ...
      // ── 12-5 데이터 한계 ─────────────────────────────────
      {
        ...
        callout: {
          ...
          body:
            "첫째, NH, KB, 한국투자증권 등 국내 PC 운용사별 부문 AUM 별도 공시가 부재하다.\n\n인수금융, PC 부문이 IR에서 분리 표기되지 않는다.\n\n둘째, 금감원 자본시장통계는 PEF, 헤지펀드 중심이고 PC 별도 통계가 없다.\n\n셋째, 본 노트의 한국 수치는 보도(thebell, 인베스트조선, 머니투데이, 한국경제)와 KCMI(자본시장연구원) 자료 종합이다.\n\ncross-check 권장 영역은 세 가지다.\n\n첫째, 외국계 한국 부동산 PF 실제 deployment 규모.\n\n둘째, 국내 PC 운용사 부문별 AUM.\n\n셋째, ABF의 PC 펀드 보유 비중.\n\n이 세 영역은 \"보도 기반\"임을 명시한다.²⁹",
          bodyEn:
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["결말", "PC 채권단 debt-for-equity", "회생 신청, 회수율 약 10% 미만 보도", "fire-sale (현재진행)"],
          ...
          caption: "세 사건 모두 2025년 봄~여름에 신호를 보냈다. 자산 클래스, 지역, 트리거는 다르지만 원금 손상, 유동성 한계, valuation 신뢰라는 같은 질문에 도달한다.",
    ...
    blocks: [
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "Source: IMF GFSR April 2024 Ch.2, BoE FSR Nov 2024, BIS Quarterly Review March 2025 종합. 위험 강도는 채널별 상대 평가다. danger(빨강) = 즉시 전염, caution(주황) = 지연 전염, info(파랑) = 잠재 채널.",
      ...
      },
      {
        ...
        callout: {
          variant: "warning",
          heading: "양쪽 모두 맞다, 단 시점이 다르다",
          headingEn: "Both Sides Are Right — But on *Different Timeframes*",
          body:
            "Marc Rowan(Apollo), Howard Marks(Oaktree)의 반론은 현재 디폴트 수치에 기반한다.\n\nPC 자체는 sponsor 인센티브 정렬, hold-to-maturity, bilateral covenant로 BSL보다 안전하다는 입장이다.\n\n단, Marks는 2024년 \"What's Going on in Private Credit?\" 메모에서 software LBO 집중과 AI disruption 가능성을 명시 경고했다.\n\n결론은 \"credit carelessness 있으나 systemic은 아니다\"였다 (CNBC 2025.11).\n\n반대편에서 Cliff Asness(AQR)의 \"Volatility Laundering\"은 mark-to-market 부재를 핵심으로 한다.\n\nPE/PC는 quarterly fair value를 쓰기 때문에 표시 변동성이 낮아 보일 뿐이라는 주장이다.\n\nIMF, BIS, BoE는 stale valuation, opacity, leverage layers, interconnections 네 가지를 공식 경고했다.\n\n양쪽 합의 사항은 분명하다.\n\nPC 자체 디폴트는 낮다.\n\n단, 5채널 인터커넥션 stress test가 부재하다.³⁴",
          bodyEn:
    ...
    blocks: [
      ...
      },
      {
        ...
        chart: {
          ...
          caption: "출처: 각 지표는 KBRA DLD, Proskauer, BCRED 8-K, ILPA, NAIC, thebell, Apollo IR에서 update된다. 현재 status는 2025 H1에서 2026.5.31까지 verified data 기준이다. 종합 판정은 표 하단에 자동으로 표시된다.",
          ...
          data: [
            ...
            { indicator: "PC Cov-Lite 비율", indicatorEn: "PC cov-lite share", current: "약 21% (24-25, 일반 PC 평균)", normalRange: "<15%", cautionRange: "15-30%", dangerRange: "30%+", status: "caution", source: "Proskauer", sourceEn: "Proskauer" },
            ...
            { indicator: "한국 MBK 홈플러스 회수율", indicatorEn: "MBK Homeplus recovery rate", current: "약 10% 미만 보도 (2025)", normalRange: "30%+", cautionRange: "10-30%", dangerRange: "<10%", status: "danger", source: "회생법원 + 보도", sourceEn: "Court + press" },
          ],
        },
      },
    ],
    ...
    blocks: [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ["PC", "Private Credit", "비상장 사모대출. 운용사가 직접 모집, 실행한다"],
            ...
            ["DL", "Direct Lending", "직접대출. PC의 가장 큰 자산군 (약 44%)"],
          ...
          caption: "30개 용어는 본문에서 적어도 한 번씩 등장했다. 시리즈 cross-link로, ABF, spread 모델은 → ✓dollar-hegemony 시리즈의 보험사, 연금 메커니즘과 연결되고, retail BDC 환매는 → ✓ai-capital-cycle 시리즈의 hyperscale capex financing과 연결된다.",
      ...
      },
      {
        ...
        callout: {
          ...
          body:
            "17년 호황의 끝자락에 우리가 본 것은 PC가 mainstream asset class로 들어선 바로 그 순간, 첫 cycle stress가 시작됐다는 사실이다.\n\nMBK 홈플러스(한국), Pluralsight debt-for-equity(미국 LBO), Blue Owl OBDC II fire-sale(retail PC) 세 사건은 trinity다.\n\n같은 분기, 다른 axes, 같은 질문이다.\n\n답은 5채널 인터커넥션(✓14)이 어떻게 작동하는지가 결정한다.\n\n그렇기에 watch dashboard 7개를 매주 본다.",
          bodyEn:
