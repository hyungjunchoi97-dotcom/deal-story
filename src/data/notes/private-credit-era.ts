...
export const privateCreditEra: NoteData = {
  ...
  description:
    "MBK 홈플러스 회생, Blue Owl OBDC II 자산 fire sale, Apollo CEO의 'shakeout' 발언이 한 분기에 겹친 17년 호황의 끝자락. PC가 $250B에서 $1.7T로 성장한 17년사, 빅 7 플레이어, 한국 진입, 5채널 전염 메커니즘, 매주 봐야 할 7지표까지 38분에 정리.",
  descriptionEn:
  ...
  readingMinutes: 38,
  keyPoints: [
    "사모대출(Private Credit, PC) 시장은 2008년 $250B에서 2024년 $1.7T로 17년간 약 7배 성장 (Preqin 협의 정의).",
    "성장의 트리거는 단순. Basel III(2013-2019)와 미국 Leveraged Lending Guidance(2013)가 은행을 6x EBITDA 이상 거래에서 밀어냈고, 그 자리를 PC가 채움.",
    "Direct Lending은 PC의 약 44%를 차지하는 주력 자산군. 미국 LBO 자금조달에서 PC는 2010년 약 10%에서 2024년 약 50%로 점유율을 확장.",
    "빅 7(Apollo, Blackstone, KKR, Ares, Blue Owl, Oaktree, HPS)이 운용 자산의 절반 이상을 통제. Apollo는 자회사 보험사 Athene 자산을 ABF로 운용하는 '스프레드 차익' 모델의 원조.",
    "한국 인수금융 시장은 2024년 ₩20.3조. 1위 KB증권(₩2.96조). MBK 홈플러스는 2025년 3월 회생절차에 진입, 부채 ₩8.5조 누적. 한국 PEF·인수금융 최대 손실 사례 가능성.",
    "PC default rate는 2024년 Q4 기준 2.67%로 BSL의 4.33%보다 낮음. 단 IMF, BIS, BoE는 stale valuation, opacity, leverage layers, interconnection을 시스템 리스크로 명시.",
    "전염 경로는 5개. 자산운용사 재간접, 보험사 GA, semi-liquid 인터벌 펀드, 은행의 PC 펀드 신용공여, retail BDC. 매주 봐야 할 7개 지표가 watch dashboard로 정리됨.",
    "Marc Rowan(Apollo)은 2024-25년 'shakeout' 발언과 함께 \"부채의 20-30%만 은행, 나머지는 investment marketplace\"라는 새 구조를 선언. Howard Marks는 \"credit carelessness는 있으나 systemic은 아니다\"로 한 발 뺌.",
    "BlackRock의 HPS 인수(2025.7 완결, 약 $220B 합산 PC AUM)는 \"public + private fixed income\" 통합 시대의 신호탄. PC는 이제 mainstream asset class.",
  ],
  keyPointsEn: [
