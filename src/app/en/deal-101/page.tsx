...
const CONCEPT_CATALOG = [
  ...
  },
  {
    ...
    tagline: "Revenue-based valuation when EBITDA is negative — the math behind Slack at 26x and Figma at 50x",
    category: "Valuation",
    published: true,
  },
  {
    slug: "arr-multiple",
    term: "ARR Multiple",
    tagline: "SaaS-specific valuation — enterprise value vs annual recurring revenue through bubble and correction",
    category: "Valuation",
    published: true,
  },
  {
    slug: "saas-valuation",
    term: "SaaS Valuation",
    tagline: "ARR, NRR, Rule of 40 — why subscription software businesses are valued on completely different terms",
    category: "Valuation",
    published: true,
  },
  // Deal Structure
  ...
  },
  {
    slug: "tender-offer",
    term: "Tender Offer",
    tagline: "Going directly to shareholders, bypassing the board — from Musk's Twitter gambit to hostile defense strategies",
    category: "Deal Structure",
    published: true,
  },
  {
    slug: "spinoff",
    term: "Spin-off",
    tagline: "Separating a unit to unlock hidden value — PayPal from eBay, GE's three-way breakup",
    category: "Deal Structure",
    published: true,
  },
  {
    ...
    tagline: "Spin off, then merge — saving billions in taxes on a large divestiture (AT&T / WarnerMedia)",
    category: "Deal Structure",
    published: true,
  },
  {
  ...
  },
  {
    ...
    tagline: "Antitrust, national security, sector regulators — five invisible walls that can kill any deal",
    category: "Regulatory & Legal",
    published: true,
  },
  // Due Diligence
  ...
  // Strategy
  {
    slug: "strategic-ma",
    term: "Strategic M&A",
    tagline: "Market position, technology, and talent over pure financial returns — why Meta paid $1B for Instagram with zero revenue",
    category: "Strategy",
    published: true,
  },
  {
    ...
    tagline: "Owning the supply chain to control cost, quality, and competition — why Amazon and Apple make everything themselves",
    category: "Strategy",
    published: true,
  },
  {
    ...
    tagline: "From one-time sales to ARR — the economics of Adobe's journey from $10B to $330B",
    category: "Strategy",
    published: true,
  },
  {
    ...
    tagline: "Network effects and the M&A premium — what Google × YouTube and Microsoft × LinkedIn have in common",
    category: "Strategy",
    published: true,
  },
  {
    ...
    tagline: "Buffett's moat framework applied to M&A multiples — network effects, switching costs, brands, scale",
    category: "Strategy",
    published: true,
  },
];
