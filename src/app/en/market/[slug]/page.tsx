...
export async function generateMetadata({
  ...
  return {
    title: `${concept.titleEn} — Market Story`,
    description: concept.excerptEn,
    alternates: {
      canonical: `/en/market/${slug}`,
      languages: {
        ko: `/market/${slug}`,
        en: `/en/market/${slug}`,
...
export default async function MarketConceptPageEn({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
        ...
        <section className="border-b border-gray-200/60 dark:border-gray-700/60 bg-gray-50 dark:bg-gray-900/50">
          <div className="max-w-3xl mx-auto px-5 py-10">
            ...
            <div className="flex items-center gap-1.5 text-xs text-gray-400 dark:text-gray-500 mb-4">
              ...
              <span>›</span>
              <Link href="/en/market" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors">Market Story</Link>
              <span>›</span>
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {related.map((rel) => {
                  ...
                  return (
                    <Link key={rel.slug} href={`/en/market/${rel.slug}`}>
