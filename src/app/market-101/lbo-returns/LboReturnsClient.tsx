        ...
        <section className="border-b border-gray-200/60 dark:border-gray-700/60">
          <div className="max-w-3xl mx-auto px-5 py-10">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4, delay: 0.25 }} className="mt-4 flex items-center gap-2">
              <Link href="/market-101/lbo-returns" className={`text-[11px] px-2.5 py-1 rounded-full font-medium transition-colors ${ko ? "text-white" : "text-gray-400 hover:text-gray-600"}`} style={ko ? { background: ACCENT } : {}}>한국어</Link>
              <Link href="/en/market-101/lbo-returns" className={`text-[11px] px-2.5 py-1 rounded-full font-medium transition-colors ${!ko ? "text-white" : "text-gray-400 hover:text-gray-600"}`} style={!ko ? { background: ACCENT } : {}}>English</Link>
            </motion.div>
          </div>
        </section>
        ...
        <div className="max-w-3xl mx-auto px-5 py-6 space-y-20">
          ...
          <motion.section variants={stagger} initial="hidden" whileInView="show" viewport={VP}>
            <div className="flex flex-wrap gap-3">
              <Link href={ko ? "/market-101/lbo-capital-structure" : "/en/market-101/lbo-capital-structure"}
              ...
              <Link href={ko ? "/market-101/lbo-deal-process" : "/en/market-101/lbo-deal-process"}
