...
export async function generateMetadata({
  ...
  return {
    title: `${concept.title} — Market Story`,
    ...
    alternates: {
      ...
      languages: {
        ko: `/market/${slug}`,
        en: `/en/market/${slug}`,
        "x-default": `/market/${slug}`,
      },
    },
  };
}

// 카테고리별 액센트 컬러 (Tailwind 동적 클래스 방지 위해 인라인 스타일 사용)
...
export default async function MarketConceptPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
        ...
        <section className="border-b border-gray-200/60 dark:border-gray-700/60 bg-gray-50 dark:bg-gray-900/50">
          <div className="max-w-3xl mx-auto px-5 py-10">
            ...
            <div className="flex items-center gap-1.5 text-xs text-gray-400 dark:text-gray-500 mb-4">
              ...
              <span>›</span>
              <Link href="/market" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors">Market Story</Link>
              <span>›</span>
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {related.map((rel) => {
                  ...
                  return (
                    <Link key={rel.slug} href={`/market/${rel.slug}`}>
