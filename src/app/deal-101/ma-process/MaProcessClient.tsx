...
const PHASES = [
  {
    ...
    documents: [
      { name: "인수전략 메모 (M&A Rationale)", desc: "왜 이 타겟인가. 이사회 승인용 내부 문서. 시너지 추정치와 최대 지불 가격(Walk-away Price)이 핵심 내용." },
      { name: "롱리스트 / 쇼트리스트", desc: "업계 전체 잠재 타겟을 50~100개로 추린 뒤, 전략·재무 기준으로 5~10개로 압축. 이후 접촉 순서를 결정." },
      { name: "재무 스크리닝 모델", desc: "공개 정보(재무제표, IR) 기반 초기 EV/EBITDA 추정. 정밀도보다 방향성 확인이 목적." },
    ],
  ...
  },
  {
    ...
    documents: [
      { name: "Teaser (티저)", desc: "1~2페이지 분량의 익명 요약 자료. 회사명 없이 '국내 1위 xx 기업' 식으로 업종·규모·실적만 공개. 관심 여부를 타진하는 첫 문서." },
      { name: "NDA (비밀유지계약)", desc: "IM 제공 전 필수. 입찰 과정에서 얻은 정보를 외부에 유출하거나 딜 무산 후 악용하는 것을 방지. 위반 시 손해배상 조항 포함." },
      { name: "IM / CIM (정보제공각서)", desc: "100~200페이지 분량의 상세 자료. 사업 개요, 재무 실적, 시장 분석, 핵심 경영진, 리스크 등 포함. 이 문서를 보고 LOI 가격을 작성." },
      { name: "Process Letter", desc: "입찰 일정·규칙을 담은 공문. LOI 제출 마감일, 허용 조건, 우선협상대상자 선정 기준 등이 명시." },
    ],
