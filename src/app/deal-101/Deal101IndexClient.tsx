...
const KO_CONCEPT_CATALOG: ConceptItem[] = [
  ...
  { slug: "ma-ch00-overview",     term: "M&A 시리즈 — Deal Type Matrix (Ch.0)", tagline: "GS·MS·JPM M&A 실무 풀 라이프사이클 14챕터 + 5축 인터랙티브 — Sell/Buy, Auction/Negotiated, Public/Private/Carve-out/Distressed 분기", category: "기타", published: true  },
...
const EN_CONCEPT_CATALOG: ConceptItem[] = [
  ...
  { slug: "ma-ch00-overview",     term: "M&A Series — Deal Type Matrix (Ch.0)", tagline: "GS·MS·JPM M&A full lifecycle in 14 chapters + interactive 5-axis matrix — sell/buy, auction/negotiated, public/private/carve-out/distressed forks", category: "Other", published: true },
