...
const CASES = [
  {
    ...
    paragraphs: [
      ...
      "2025년 3월, 홈플러스는 기업회생절차(법정관리)를 신청했다. Sale & Leaseback으로 4조원 이상을 단기에 회수했지만, 높은 임차료 부담과 이커머스發 매출 하락이 겹쳐 재무 구조가 무너졌다.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "WeWork의 IPO 준비 과정에서 다양한 외부 분석가·내부 실사팀이 코워킹 시장의 경쟁 심화, WeWork의 지속 가능한 경쟁 우위 부재, 부동산 임대 사이클 리스크를 경고했다. 그러나 $47B 밸류에이션 목표 하에서 이러한 경고들은 묻혔다.",
